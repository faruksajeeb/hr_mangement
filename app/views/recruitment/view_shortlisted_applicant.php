...
<html lang="en">
    <head>
        ...
        <title>Shortlisted Applicant</title>
        <?php
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row under-header-bar text-center"> 
                    <h4>Shortlisted Applicant(<?php echo $shortlist_num_row; ?>)</h4>         
                </div> 
                <div class="wrapper">
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%" border="1">
                                ...
                                <tbody>
                                    <?php
                                    $sl_no = 1;
                                    foreach ($all_shortlisted_applicant as $single_applicant) {
                                        ?>
                                        <tr class="separator">
                                    ...
                                    echo date_format($appliedOn, 'F j, Y');
                                        ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url(); ?>recruitment/trash_applicant_by_id/shortlisted/<?php echo $single_applicant->ApplicantID ?>" class="btn btn-danger  btn-xs" onclick="return checkDelete()"><span class="glyphicon glyphicon-remove-circle" title="Trash"  ></span> reject</a>
                                            </td>
                                        </tr>
                                        <?php $sl_no++;
                                    }
