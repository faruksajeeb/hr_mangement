...
<html lang="en">
    <head>
        ...
        <title>Interview Applicant List</title>
        <?php
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row under-header-bar text-center"> 
                    <h4>Interview Applicant List(<?php echo $interview_num_row; ?>)</h4>         
                </div> 
                <div class="wrapper">
                          ...
                          <a href="<?php echo base_url(); ?>recruitment/selected_applicant" class="btn btn-primary pull-right" style="margin: 5px;"><span class="glyphicon  glyphicon-list"></span> Selected (<?php echo $selected_num_row; ?>)</a>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%" border="1">
                                ...
                                <tbody>
                                    <?php
                                    $sl_no = 1;
                                    foreach ($all_interview_applicant as $single_applicant) {
                                        ?>
                                        <tr class="separator">
                                    ...
                                    echo date_format($appliedOn, 'F j, Y');
                                        ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url(); ?>recruitment/trash_applicant_by_id/interview/<?php echo $single_applicant->ApplicantID ?>" class="btn btn-danger  btn-xs" onclick="return checkDelete()"><span class="glyphicon glyphicon-remove-circle" title="Trash"  ></span> reject</a>
                                            </td>
                                        </tr>
                                        <?php $sl_no++;
                                    }
