  ...
  <div id="page-content-wrapper">
    <div class="container-fluid">
      ...
      <div class="wrapper">
        <div class="row">
          <div class="col-md-12">
          <form action="<?php echo base_url(); ?>reports/resume" method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
...
<div id="width="100%""> 
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
      ...
      <!--Photograph:-->
        ...
        <table width="140" height="140" border="0" align="center" cellpadding="0" cellspacing="7" bgcolor="#dadce1">
          ...
          <td width="126" height="135" align="center" bgcolor="#e2e4e5" valign="middle"> 
           <?php 
          $picture_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "resources/uploads");
      ...
      <!--Contact Address:-->
          <?php 
          $contact_address_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_present_address");
      ...
      <!--Home Phone:-->
      <?php 
          $emp_home_phone_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_home_phone");
      ...
      <!--Office Phone:-->
      <?php 
          $emp_office_phone_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_office_phone");
      ...
      <!--Mobile:-->
      <?php 
          $emp_mobile_no_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_mobile_no");
          $emp_mobile_no=$emp_mobile_no_data[0]['field_value'];
          if($emp_mobile_no){
          print "<br> Mobile: ".$emp_mobile_no;
          } ?> 
      <?php 
          $emp_email_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_email");
   ...
   <table border="0" cellpadding="0" style="margin-top:3px;" cellspacing="0" align="center" width="100%">
     ...
     <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
        ...
        <tr class="BDJNormalText02">
          ...
          <?php 
          $emp_exp_position_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_1");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_1");
          ...
          <?php 
          $emp_exp_dateto_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_1");
          ...
          &nbsp;          
            ...
            <?php 
          $emp_exp_duration_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_1");
          ...
          print $emp_exp_duration_1;
             ...
             <?php 
          $emp_exp_organization_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_1");
        ...
        <tr class="BDJNormalText02">
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_position_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_2");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_2");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_dateto_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_2");
          ...
          &nbsp;          
            ...
            <!--Duration:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_exp_duration_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_2");
          ...
          print $emp_exp_duration_2;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_exp_organization_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_2");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_position_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_3");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_3");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_dateto_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_3");
          ...
          &nbsp;          
            ...
            <!--Duration:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_exp_duration_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_3");
          ...
          print $emp_exp_duration_3;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_exp_organization_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_3");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_position_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_4");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_4");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_dateto_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_4");
          ...
          &nbsp;          
            ...
            <!--Duration:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_exp_duration_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_4");
          ...
          print $emp_exp_duration_4;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_exp_organization_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_4");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_position_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_5");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_5");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_dateto_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_5");
          ...
          &nbsp;          
            ...
            <!--Duration:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_exp_duration_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_5");
          ...
          print $emp_exp_duration_5;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_exp_organization_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_5");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_position_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_6");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_6");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_dateto_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_6");
          ...
          &nbsp;          
            ...
            <!--Duration:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_exp_duration_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_6");
          ...
          print $emp_exp_duration_6;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_exp_organization_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_6");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_position_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_position_7");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_exp_datefrom_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_datefrom_7");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_exp_dateto_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_dateto_7");
          ...
          &nbsp;          
            ...
            <!--Duration:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_exp_duration_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_duration_7");
          ...
          print $emp_exp_duration_7;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_exp_organization_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_exp_organization_7");
...
-->
   ...
   <table border="0" cellpadding="0" style="margin-top:3px;" cellspacing="0" align="center" width="100%">
     ...
     <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
        ...
        <?php 
          $emp_education_level_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_level_1");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_degree_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_degree_1");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_education_major_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_major_1");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_institute_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_institute_1");
          ...
          &nbsp;          
            ...
            <!--Passing Year:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_education_year_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_year_1");
          ...
          print $emp_education_year_1;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_education_results_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_results_1");
          ...
          <!--Exam Title:-->
            ...
            <td width="20%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_education_level_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_level_2");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_degree_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_degree_2");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_education_major_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_major_2");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_institute_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_institute_2");
          ...
          &nbsp;          
            ...
            <!--Passing Year:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_education_year_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_year_2");
          ...
          print $emp_education_year_2;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_education_results_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_results_2");
          ...
          <!--Exam Title:-->
            ...
            <td width="20%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_education_level_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_level_3");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_degree_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_degree_3");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_education_major_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_major_3");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_institute_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_institute_3");
          ...
          &nbsp;          
            ...
            <!--Passing Year:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_education_year_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_year_3");
          ...
          print $emp_education_year_3;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_education_results_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_results_3");
          ...
          <!--Exam Title:-->
            ...
            <td width="20%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_education_level_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_level_4");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_degree_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_degree_4");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_education_major_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_major_4");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_institute_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_institute_4");
          ...
          &nbsp;          
            ...
            <!--Passing Year:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_education_year_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_year_4");
          ...
          print $emp_education_year_4;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_education_results_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_results_4");
          ...
          <!--Exam Title:-->
            ...
            <td width="20%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_education_level_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_level_5");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_degree_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_degree_5");
          ...
          <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
         <?php 
          $emp_education_major_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_major_5");
          ...
          <td width="12.5%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
          <?php 
          $emp_education_institute_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_institute_5");
          ...
          &nbsp;          
            ...
            <!--Passing Year:-->
             ...
             <td width="12.5%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
            <?php 
          $emp_education_year_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_year_5");
          ...
          print $emp_education_year_5;
             ...
             <td width="10%" style="border-right:1px solid #666666;border-top:1px solid #666666;" align="center">
             <?php 
          $emp_education_results_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_education_results_5");
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin-top:3px;">
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
     ...
     <td width="15%" align="center" style="border-right:1px solid #666666"><strong>Name of Organization</strong></td>
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_1");
        ...
        <?php 
          $emp_training_datefrom_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_1");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_1");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_1");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_1");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_2");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666; padding-left:1px;">
        <?php 
          $emp_training_datefrom_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_2");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_2");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_2");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_2");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_3");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666; padding-left:1px;">
        <?php 
          $emp_training_datefrom_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_3");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_3");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_3");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_3");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_4");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666; padding-left:1px;">
        <?php 
          $emp_training_datefrom_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_4");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_4");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_4");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_4");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_5");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666; padding-left:1px;">
        <?php 
          $emp_training_datefrom_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_5");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_5");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_5");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_5");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_6");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666; padding-left:1px;">
        <?php 
          $emp_training_datefrom_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_6");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_6");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_6");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_6_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_6");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_course_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_course_7");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666; padding-left:1px;">
        <?php 
          $emp_training_datefrom_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_datefrom_7");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_dateto_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_dateto_7");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_duration_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_duration_7");
         ...
         <td width="15%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_training_organization_7_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_training_organization_7");
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin-top:3px;">
     ...
     <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
       ...
       <td width="100%" align="center" style="border-right:1px solid #666666"><strong>Topics</strong></td>
        ...
        <?php 
          $emp_computer_training_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_computer_training");
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin-top:3px;">
     ...
     <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
       ...
       <td width="25%" align="center"><strong>Listening</strong></td>
        ...
        <?php 
          $emp_language_name_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_name_1");
          ...
          print $emp_language_name_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_reading_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_reading_1");
          ...
          print $emp_language_reading_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_writing_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_writing_1");
          ...
          print $emp_language_writing_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_speaking_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_speaking_1");
          ...
          print $emp_language_speaking_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_listening_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_listening_1");
          ...
          print $emp_language_listening_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_name_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_name_2");
          ...
          print $emp_language_name_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_reading_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_reading_2");
          ...
          print $emp_language_reading_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_writing_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_writing_2");
          ...
          print $emp_language_writing_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_speaking_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_speaking_2");
          ...
          print $emp_language_speaking_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_listening_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_listening_2");
          ...
          print $emp_language_listening_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_name_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_name_3");
          ...
          print $emp_language_name_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_reading_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_reading_3");
          ...
          print $emp_language_reading_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_writing_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_writing_3");
          ...
          print $emp_language_writing_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_speaking_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_speaking_3");
          ...
          print $emp_language_speaking_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_language_listening_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_language_listening_3");
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin-top:3px;">
     ...
     <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
       ...
       <td width="14%" align="center"><strong>Relation</strong></td>
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_name_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_name_1");
          ...
          print $emp_reference_name_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_position_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_position_1");
          ...
          print $emp_reference_position_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_org_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_org_1");
          ...
          print $emp_reference_org_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_address_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_address_1");
          ...
          print $emp_reference_address_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_phone_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_phone_1");
          ...
          print $emp_reference_phone_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_email_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_email_1");
          ...
          print $emp_reference_email_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_relation_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_relation_1");
          ...
          print $emp_reference_relation_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_name_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_name_2");
          ...
          print $emp_reference_name_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_position_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_position_2");
          ...
          print $emp_reference_position_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_org_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_org_2");
          ...
          print $emp_reference_org_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_address_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_address_2");
          ...
          print $emp_reference_address_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_phone_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_phone_2");
          ...
          print $emp_reference_phone_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_email_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_email_2");
          ...
          print $emp_reference_email_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_relation_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_relation_2");
          ...
          print $emp_reference_relation_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_name_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_name_3");
          ...
          print $emp_reference_name_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_position_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_position_3");
          ...
          print $emp_reference_position_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_org_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_org_3");
          ...
          print $emp_reference_org_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_address_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_address_3");
          ...
          print $emp_reference_address_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_phone_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_phone_3");
          ...
          print $emp_reference_phone_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_email_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_email_3");
          ...
          print $emp_reference_email_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_reference_relation_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_reference_relation_3");
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin-top:3px;">
     ...
     <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="border:1px solid #666666">
       ...
       <td width="14%" align="center"><strong>Nominee Type</strong></td>
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_name_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_name_1");
          ...
          print $emp_dependent_name_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_dob_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_dob_1");
          ...
          print $emp_dependent_dob_1;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_relation_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_relation_1");
          ...
          if($emp_dependent_relation_1){
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_nomtype_1_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_nomtype_1");
...
<tr class="BDJNormalText02">
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_name_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_name_2");
          ...
          print $emp_dependent_name_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_dob_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_dob_2");
          ...
          print $emp_dependent_dob_2;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_relation_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_relation_2");
          ...
          if($emp_dependent_relation_2){
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_nomtype_2_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_nomtype_2");
...
<tr class="BDJNormalText02">
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_name_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_name_3");
          ...
          print $emp_dependent_name_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_dob_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_dob_3");
          ...
          print $emp_dependent_dob_3;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_relation_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_relation_3");
          ...
          if($emp_dependent_relation_3){
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_nomtype_3_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_nomtype_3");
...
<tr class="BDJNormalText02">
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_name_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_name_4");
          ...
          print $emp_dependent_name_4;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_dob_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_dob_4");
          ...
          print $emp_dependent_dob_4;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_relation_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_relation_4");
          ...
          if($emp_dependent_relation_4){
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_nomtype_4_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_nomtype_4");
...
<tr class="BDJNormalText02">
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_name_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_name_5");
          ...
          print $emp_dependent_name_5;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_dob_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_dob_5");
          ...
          print $emp_dependent_dob_5;
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_relation_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_relation_5");
          ...
          if($emp_dependent_relation_5){
           ...
           <td width="25%" align="center" style="border-right:1px solid #666666;border-top:1px solid #666666;">
        <?php 
          $emp_dependent_nomtype_5_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_dependent_nomtype_5");
   ...
   <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="margin-top:3px;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
      <!--Fathers Name:-->
         ...
         <?php 
          $emp_fathername_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_fathername");
      ...
      <!--Mothers Name:-->
         ...
         <td width="76%" align="left">
         <?php 
          $emp_mothername_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_mothername");
      ...
      <td width="76%" align="left">
       <?php 
          $marital_status=$default_emp['marital_status'];
          if($marital_status){
      ...
      <td align="left">
        <?php 
          $emp_nationality_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_nationality");
      ...
      <!--Permanent Address:-->
         ...
         <td align="left">
          <?php 
          $emp_parmanent_address_data=$this->emp_details_model->getcontentByidandname($defaultcontent_id, "emp_parmanent_address");
