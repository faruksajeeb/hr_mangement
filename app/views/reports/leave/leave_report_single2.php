  ...
  <div id="page-content-wrapper">
    <div class="container-fluid">
      ...
      <div class="wrapper">
        <div class="row">
          <div class="col-md-12">
          <form action="<?php echo base_url(); ?>reports_leave/single_leave_report2" method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-12">
                <table id="eexample" class="display" cellspacing="0" width="100%" border="1">
                  <thead>
                    <tr class="heading">
                      <th>Leave Type</th>
                      <th>Spent Leave</th>
