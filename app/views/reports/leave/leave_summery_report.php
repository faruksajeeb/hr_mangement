  ...
  <div id="page-content-wrapper">
    <div class="container-fluid">
      ...
      <div class="wrapper">
        <div class="row">
          <div class="col-md-12">
            <form action="<?php echo base_url(); ?>leave_summery_report"  method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
