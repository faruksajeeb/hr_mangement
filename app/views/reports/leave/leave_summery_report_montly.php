...
<head>
  ...
  <title>Employee Wise Montly Leave Reports</title>
  <?php
  ...
  <div id="page-content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row under-header-bar text-center"> 
        <h4>Monthly Leave Reports by Multiple</h4>         
      </div> 
      <div class="wrapper">
        <div class="row">
          <div class="col-md-12">
            <form action="<?php echo base_url(); ?>leave_summery_report_monthly"  method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
              ...
              <div class="row"> 
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-3 bgcolor_D8D8D8">Date Range:</div>
                    <div class="col-md-4"><input type="text" name="emp_attendance_start_date" class="datepicker numbersOnly" id="emp_attendance_start_date" value="<?php if($default_start_date){ print $default_start_date; }else{ print $first_day_this_month; } ?>" placeholder="dd-mm-yyyy"></div>
                    <div class="col-md-4"><input type="text" name="emp_attendance_end_date" class="datepicker numbersOnly" id="emp_attendance_end_date" value="<?php if($default_end_date){ print $default_end_date; }else{ print $last_day_this_month; } ?>" placeholder="dd-mm-yyyy"></div>
                  </div>                                                                                                                                                                                                                                                                                                              
        ...
        <div class="row">
          <div class="col-md-12 text-right"><a target="_blank" href="<?php echo site_url("savepdf/leavesummarymonthlypdf") ; ?>"  class="operation-print-pdf operation-link"> <img src="<?php echo base_url(); ?>resources/images/pdf_icon_print.png" alt="pdf" style="width:20px;"/></a></div>
        </div>        
        <div class="emp_info">
          <div class="row">
            <div class="col-md-2">Division Name:</div>
            <div class="col-md-7"><?php echo $defsultdivision_name; ?></div>
            <div class="col-md-1">Date Range:</div>
            <div class="col-md-2"><?php echo $default_start_date." to ".$default_end_date; ?></div>
          </div>
          <div class="row">
            <div class="col-md-2">Short Name:</div>
            <div class="col-md-7"><?php echo $defsultdivision_shortname; ?></div>
            <div class="col-md-1">Time:</div>
            <div class="col-md-2"><?php echo $nowtime; ?></div>
          </div>                                                
        </div>         
        <div class="row">
          <div class="col-md-12">
            <table id="example" class="display" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                foreach ($emp_codes as $single_code) {
                  ...
                  $emp_total_leave = $this->emp_yearly_leave_history_model->getemp_yearlyleave_historybydate($emp_content_id, $default_start_date);                           
                //   $total_leave_spent_query= $this->emp_leave_model->getemp_yearlyleavebyyear($emp_content_id, $year);
                  $total_leave_spent_query= $this->emp_leave_model->getEmployeeMonthlyLeave($emp_content_id, $default_start_date, $default_end_date);
                  foreach ($total_leave_spent_query as $single_spent_leave) {
                    ...
                    $leave_spent_date .="<span style='padding:2px;margin:1px' class='label label-info'>".$single_spent_leave['leave_start_date']."</span>";
                  }
