...
<head>
    ...
    <title>Advance Salary Reports</title>
    <?php
...
<body class="logged-in dashboard current-page add-attendance">
        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                <div style="border:1px solid #CCC; padding-bottom:5px" class="col-md-10 col-lg-10 col-sm-10 col-md-offset-1">
                    <h3 class="text-center bg-warning" style="padding:20px; background-color:#696969; color:#FFF"> Advance Salary Statement </h3>
                    <div class="row">
        ...
        $(document).ready(function() {
            ...
            $('#btn_generate').on('click', function(e) {
                ...
                if (!content_id) {
                    ...
                    $.ajax({
                        url: url_prefix + "advance-salary-statement",
                        dataType: 'html',
                        type: 'POST',
                        data: {
            ...
            $(".exportToExcel").click(function(e) {
                ...
                if (table && table.length) {
                    ...
                    $(table).table2excel({
                        ...
                        filename: "advance_salary_statement_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                        fileext: ".xls",
                        exclude_img: true,
                        exclude_links: true,
                        exclude_inputs: true,
    ...
    <span style="padding-left:8px;font-family:Verdana, Geneva, sans-serif">Advance Salary Report <br><?php print $nowbigmonth; ?></span>' +
                '</div>\n\
    </div><br>';
            popupWin.document.write('<html><head><title>Advance Salary Report </title>\n\
    \n\
    \n\
    \n\
    \n\
