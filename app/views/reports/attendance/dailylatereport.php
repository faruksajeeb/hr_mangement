    ...
    <div class="container-fluid">
      ...
      $this -> load -> view('includes/menu');
            ...
            <div class="wrapper">
              <div class="row">
                <div class="col-md-12">
                  <form action="<?php echo base_url(); ?>reports/dailylatereports" method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-right"><a onclick="return popitup('<?php echo site_url("savepdf/dailylatereportspdf") ; ?>')" href="<?php echo site_url("savepdf/dailylatereportspdf") ; ?>" class="operation-print-pdf operation-link"> <img src="<?php echo base_url(); ?>resources/images/pdf_icon_print.png" alt="pdf" style="width:20px;"/></a></div>
                  </div>
                    ...
                    if ($holiday_exist) {
                      ...
                      $holiday_name_info = $this->taxonomy->getTaxonomyBytid($holiday_type_tid);
                        ...
                        <tr style="margin-bottom:10px;background: #40618C;color: #fff;font-size: 17px;">
                          <td width="53%"><span style="font-weight: bold; font-style: italic;border-bottom:2px solid #000">Total Employee <?php print $total_emp; ?>; Total No of Late <?php print $late_counter; ?></span></td>
