...
<body class="logged-in dashboard">
		...
		<div class="container-fluid">
			...
			<div class="row ">
				<div style="border:1px solid #CCC; padding-bottom:5px" class="col-md-8 col-lg-8 col-sm-8 col-md-offset-2">
					<h3 class="text-center bg-warning" style="padding:20px; background-color:#696969; color:#FFF"> DAILY ABSENT </h3>
					<div class="row">
		...
		$(document).ready(function() {
			...
			$('#btn_generate').on('click', function(e) {
				...
				if (!company_id || !division_id || !attendance_date) {
					...
					$.ajax({
						url: url_prefix + "get_daily_absent_report",
						dataType: 'html',
						type: 'GET',
						data: {
							company_id: company_id,
    ...
    <span style="padding-left:8px;font-family:Verdana, Geneva, sans-serif">Daily Absent Report <br><?php print $nowbigmonth; ?></span>' +
				'</div>\n\
    </div><br>';
			popupWin.document.write('<html><head><title>Daily Absent Report </title>\n\
    \n\
    \n\
    \n\
    \n\
