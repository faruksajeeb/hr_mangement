...
<head>
  ...
  <title>Employee Wise Daily Early Reports</title>
  <?php
    ...
    <div class="container-fluid">
      ...
      $this -> load -> view('includes/menu');
            ...
            <div class="row under-header-bar text-center"> 
              <h4>Daily Early Reports</h4>         
            </div> 
            <div class="wrapper">
              <div class="row">
                <div class="col-md-12">
                  <form action="<?php echo base_url(); ?>reports/dailyearlyreports" method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-right"><a onclick="return popitup('<?php echo site_url("savepdf/dailyearlyreportspdf") ; ?>')" href="<?php echo site_url("savepdf/dailyearlyreportspdf") ; ?>" class="operation-print-pdf operation-link"> <img src="<?php echo base_url(); ?>resources/images/pdf_icon_print.png" alt="pdf" style="width:20px;"/></a></div>
                  </div>
                    ...
                    if ($holiday_exist) {
                      ...
                      $holiday_name_info = $this->taxonomy->getTaxonomyBytid($holiday_type_tid);
                                            ...
                                            <tr>
                                              ...
                                              <td><?php print $emp_division_shortname; ?></td>
                                                ...
                                                if($remarks=="Late & Early"){
                                                  print "<span class='blue-color'>L.E</span>";
                                                }else{
                                                  print "<span class='blue-color'>E</span>";
                                                }
                                  ?>
                                </td>
                        ...
                        <tr style="margin-bottom:10px;background: #40618C;color: #fff;font-size: 17px;">
                          <td width="53%"><span style="font-weight: bold; font-style: italic;border-bottom:2px solid #000">Total Employee <?php print $total_emp; ?>;  Early Out <?php print $early_counter; ?></span></td>
