        ...
        <div class="container-fluid">
            ...
            <div class="wrapper">
                <div class="row " style="margin-top:20px">
					...
					<h3 class="text-center bg-warning" style="padding:20px; background-color:#CCC; color:#FFF"> TODAY'S PRESENT </h3>
					<table class="table table-striped custom-table mb-0">
						...
						<tbody>
						<?php foreach($today_present_data as $key => $val):?>
							<tr>
								<td><?php echo $key+1; ?></td>
								<td><?php echo $val->attendance_date; ?></td>
								<td><?php echo $val->emp_name; ?></td>
								<td><?php echo $val->emp_id; ?></td>
								<td><?php echo $val->login_time.' <i class="fas fa-arrows-alt-h"></i> '.$val->logout_time; ?></td>
								<th>-</th>
							</tr>
							<?php endforeach; ?>
						</tbody>
