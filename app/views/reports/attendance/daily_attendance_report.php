        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                <div style="border:1px solid #CCC; padding-bottom:5px" class="col-md-10 col-lg-10 col-sm-10 col-md-offset-1">
                    <h3 class="text-center bg-warning" style="padding:20px; background-color:#696969; color:#FFF"> Daily Attendance Report </h3>
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <form action="">
                                ...
                                <div class="input-group input-group-lg " style="margin-top:5px">
                                    <span class="input-group-addon" id="sizing-addon1">Report Type * </span>
        ...
        $(document).ready(function() {
            ...
            $('#btn_generate').on('click', function(e) {
                ...
                if (!company_id || !division_id || !attendance_date) {
                    ...
                    $.ajax({
                        url: url_prefix + "get_daily_attendance_report",
                        dataType: 'html',
                        type: 'GET',
                        data: {
                            company_id: company_id,
            ...
            $(".exportToExcel").click(function(e) {               
                ...
                if (table && table.length) {
                    ...
                    $(table).table2excel({
                        ...
                        filename: "daily_attendance_report_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                        fileext: ".xls",
                        exclude_img: true,
                        exclude_links: true,
                        exclude_inputs: true,
