		...
		$(document).ready(function() {
			...
			$("#myForm").validate({
				rules: {
					...
					emp_working_time_from: {
						time: true
					},
					emp_working_end_time: {
						time: true
					},
					emp_latecount_time: {
						time: true
			...
			function showActive() {
				...
				var spliid = activeId.split("_");
				var contenid = "content_" + spliid[1];
				$(".tabcontent").hide();
				$("#" + contenid).show();
			}
			...
			$(document).on('keydown', 'input#emp_id', function(e) {
				...
				if (keyCode == 9) { //tab key
					...
					$.ajax({
						type: "POST",
						url: "" + base_url + "addprofile/getempcontenid",
						data: postData,
						dataType: 'json',
						success: function(data) {
							if (data) {
				...
				<div class="row">
					<div class="col-md-12" style="padding-top:25px;">
						...
						<form action="<?php echo base_url(); ?>addprofile/do_upload" method="post" class="myForm" id="myForm" name="myForm" onSubmit="return validate();" enctype="multipart/form-data">
							...
							<div class="row ">
								<div class="col-md-12">
									<input type="submit" id="add_profile_btn" value="Save <?php if ($content_id) {
																								echo 'Changes';
																							} ?>">
							...
							<div class="row custom-row-radious2">
								<div class="tabs">
									...
									<div class="tabcontent" id="content_1">
											...
											<div class="col-md-10">
												<div class="row">
													<div class="col-md-6">
														<div class="row">
															...
															<div class="col-md-8">
																...
																<select name="emp_company" id="emp_company">
																	...
																	<?php
																	if ($user_type_id != 1) {
																		echo '<option value="' . $companies['id'] . '" selected="selected" data-id="' . $companies['weight'] . '">' . $companies['name'] . '</option>';
																	} else {
																		foreach ($companies as $single_company) {
																			if ($emp_company == $single_company['id']) {
																				echo '<option value="' . $single_company['id'] . '" selected="selected" data-id="' . $single_company['weight'] . '">' . $single_company['name'] . '</option>';
																			} else {
																				echo '<option value="' . $single_company['id'] . '" data-id="' . $single_company['weight'] . '">' . $single_company['name'] . '</option>';
																			}
																		}
																	}
																	?>
														...
														<div class="row">
															<div class="col-md-4 bgcolor_D8D8D8">Employee ID <i class="fas fa-asterisk" style="font-size:7px;color:red"></i></div>
															<div class="col-md-8"><input type="text" name="emp_id" id="emp_id" autocomplete="off" value="<?php if ($emp_id) {
																																								echo $emp_id;
														...
														<div class="row">
															<div class="col-md-4 bgcolor_D8D8D8">Employee Name <i class="fas fa-asterisk" style="font-size:7px;color:red"></i></div>
															<div class="col-md-8"><input type="text" name="emp_name" id="emp_name" autocomplete="off" value="<?php if ($emp_name) {
																																									echo $emp_name;
																																								} ?>" /></div>
														</div>
														<div class="row">
															...
															<div class="col-md-8">
																<select name="emp_division" id="emp_division">
																	...
																	<?php foreach ($division_selected as $single_division) {
																		if ($emp_division == $single_division['id']) {
																			echo '<option value="' . $single_division['id'] . '" selected="selected">' . $single_division['name'] . '</option>';
																		} else {
																			echo '<option value="' . $single_division['id'] . '">' . $single_division['name'] . '</option>';
																		}
																	} ?>
																</select>
															</div>
															...
															<div class="col-md-8">
																<select name="emp_department" id="emp_department" class="chosen-select">
																	...
																	<?php foreach ($departments as $department) { ?>
																		<option value="<?php echo $department['id']; ?>" <?php if ($department['id'] == $emp_department) {
																																echo "selected";
														...
														<div class="row">
															...
															<div class="col-md-8">
																<select name="emp_gender" id="emp_gender">
																	...
																	<option value="Male" <?php if ($emp_gender == "Male") {
																								echo 'selected="selected"';
																							} else if (!$emp_gender) {
																								echo 'selected="selected"';
																							} ?>>Male</option>
																	<option value="Female" <?php if ($emp_gender == "Female") {
																								echo 'selected="selected"';
																							} ?>>Female</option>
																	<option value="Others" <?php if ($emp_gender == "Others") {
																								echo 'selected="selected"';
																							} ?>>Others</option>
																</select>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-8"><input type="text" name="emp_dob" id="emp_dob" class="datepicker numbersOnly" placeholder="dd-mm-yyyy" value="<?php if ($emp_dob) {
																																																	echo $emp_dob;
																																																} ?>" /></div>
														</div>
													</div>
													<div class="col-md-6">
														...
														<div class="row">
															...
															<div class="col-md-8"><input type="text" name="emp_nid" id="emp_nid" onkeypress="return isNumber(event);" value="<?php if ($emp_nid) {
																																													echo $emp_nid;
																																												} ?>" /></div>
														</div>
														<div class="row">
															...
															<div class="col-md-8">
																<select name="emp_marital_status" id="emp_marital_status">
																	...
																	<?php foreach ($allmarital_status as $single_maritial_status) {
																		if ($emp_marital_status == $single_maritial_status['id']) {
																			echo '<option value="' . $single_maritial_status['id'] . '" selected="selected">' . $single_maritial_status['name'] . '</option>';
																		} else if (!$emp_marital_status && $single_maritial_status['id'] == '156') {
																			echo '<option value="' . $single_maritial_status['id'] . '" selected="selected">' . $single_maritial_status['name'] . '</option>';
																		} else {
																			echo '<option value="' . $single_maritial_status['id'] . '">' . $single_maritial_status['name'] . '</option>';
																		}
																	} ?>
																</select>
															</div>
															...
															<div class="col-md-8">
																<select name="emp_religion" id="emp_religion">
																	...
																	<?php foreach ($allreligion as $single_religion) {
																		if ($emp_religion == $single_religion['id']) {
																			echo '<option value="' . $single_religion['id'] . '" selected="selected">' . $single_religion['name'] . '</option>';
																		} else if (!$emp_religion && $single_religion['id'] == '4') {
																			echo '<option value="' . $single_religion['id'] . '" selected="selected">' . $single_religion['name'] . '</option>';
																		} else {
																			echo '<option value="' . $single_religion['id'] . '">' . $single_religion['name'] . '</option>';
																		}
																	} ?>
																</select>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-8">
																<input type="text" name="husband_wife_name" id="husband_wife_name" value="<?php if ($husband_wife_name) {
																																				echo $husband_wife_name;
																																			} ?>" />
															</div>
														</div>
														<div class="row">
															...
															<div class="col-md-8">
																<select name="emp_blood_group" id="emp_blood_group">
																	...
																	<?php foreach ($allbloodgroup as $single_blood_grp) {
																		if ($emp_blood_group == $single_blood_grp['id']) {
																			echo '<option value="' . $single_blood_grp['id'] . '" selected="selected">' . $single_blood_grp['name'] . '</option>';
																		} else {
																			echo '<option value="' . $single_blood_grp['id'] . '">' . $single_blood_grp['name'] . '</option>';
																		}
																	} ?>
																</select>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-8"><input type="text" class="numbersdotOnly" name="emp_age" id="emp_age" value="<?php if ($emp_age) {
																																									echo $emp_age;
																																								} ?>" /></div>
														</div>
														<div class="row">
															<div class="col-md-4 bgcolor_D8D8D8" title="Tax Identification Number">TIN </div>
															<div class="col-md-8"><input type="text" class="numbersdotOnly" name="emp_tin" id="emp_tin" value="<?php if ($emp_tin) {
																																									echo $emp_tin;
																																								} ?>" /></div>
														</div>
													</div>
													...
													<div class="col-md-8">
														<select name="emp_parmanent_city" id="emp_parmanent_city">
															...
															<?php foreach ($allcity as $single_city) {
																if ($emp_parmanent_city == $single_city['id']) {
																	echo '<option value="' . $single_city['id'] . '" selected="selected">' . $single_city['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_city['id'] . '">' . $single_city['name'] . '</option>';
																}
															} ?>
														</select>
													</div>
													...
													<div class="col-md-8">
														<select name="emp_parmanent_distict" id="emp_parmanent_distict" data-placeholder="Choose a District..." class="chosen-select">
															...
															<?php foreach ($alldistict as $single_distict) {
																if ($emp_parmanent_distict == $single_distict['id']) {
																	echo '<option value="' . $single_distict['id'] . '" selected="selected">' . $single_distict['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_distict['id'] . '">' . $single_distict['name'] . '</option>';
																}
															} ?>
														</select>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-8">
														<select name="emp_present_city" id="emp_present_city">
															<option value="">Select City</option>
															<?php foreach ($allcity as $single_city) {
																if ($emp_present_city == $single_city['id']) {
																	echo '<option value="' . $single_city['id'] . '" selected="selected">' . $single_city['name'] . '</option>';
																} else if (!$emp_present_city && $single_city['id'] == '209') {
																	echo '<option value="' . $single_city['id'] . '" selected="selected">' . $single_city['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_city['id'] . '">' . $single_city['name'] . '</option>';
																}
												...
												<div class="row">
													...
													<div class="col-md-8">
														<select name="emp_current_distict" id="emp_current_distict">
															...
															<?php foreach ($alldistict as $single_distict) {
																if ($emp_current_distict == $single_distict['id']) {
																	echo '<option value="' . $single_distict['id'] . '" selected="selected">' . $single_distict['name'] . '</option>';
																} else if (!$emp_current_distict && $single_distict['id'] == '235') {
																	echo '<option value="' . $single_distict['id'] . '" selected="selected">' . $single_distict['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_distict['id'] . '">' . $single_distict['name'] . '</option>';
																}
										...
										<div class="row">
											<div class="col-md-6">
												<div class="row">
													...
													<div class="col-md-8">
														<input type="text" name="emp_mobile_no" id="emp_mobile_no" autocomplete="off" class="phonenumbersOnly" value="<?php if ($emp_mobile_no) {
																																											echo $emp_mobile_no;
																																										} ?>" />
													</div>
												</div>
												...
												<select name="emp_shift" id="emp_shift" style="padding: 2px;font-size: 14px;">
													...
													foreach ($allworkingshift as $single_workingshift) {
														if ($single_workingshift['name']) {
															echo '<option value="' . $single_workingshift['id'] . '">' . $single_workingshift['name'] . '</option>';
														}
														$working_shift = "";
													} ?>
												</select>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="row">
													...
													<div class="col-md-8">
														<input type="text" name="emp_starting_date" id="emp_starting_date" class="datepicker numbersOnly" placeholder="dd-mm-yyyy" value="<?php if ($emp_starting_date) {
																																																echo $emp_starting_date;
																																															} ?>" />
													</div>
												</div>
													...
													<div class="col-md-8">
														<select name="emp_position" id="emp_position" data-placeholder="Choose a Position..." class="chosen-select">
															...
															<?php foreach ($alljobtitle as $single_jobtitle) {
																if ($emp_position == $single_jobtitle['id']) {
																	echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
																}
															} ?>
														</select>
													</div>
													...
													<div class="col-md-8">
														<select name="emp_grade" id="emp_grade">
															...
															<?php foreach ($grades as $val) : ?>
																<option value="<?php echo $val->id; ?>" <?php echo  $val->id == $emp_grade ? 'selected="selected"' : ''; ?>><?php echo $val->grade_name; ?></option>;
															<?php endforeach; ?>
														</select>
													</div>
												</div>
													...
													<div class="col-md-8">
														<select name="emp_qualification" id="emp_qualification">
															...
															<?php foreach ($allqualification as $single_qualification) {
																if ($emp_qualification == $single_qualification['id']) {
																	echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
																}
															} ?>
														</select>
													</div>
													...
													<div class="col-md-8">
														<select name="emp_type" id="emp_type">
															...
															<?php foreach ($alltypeofemployee as $single_emp_type) {
																if ($emp_type == $single_emp_type['id']) {
																	echo '<option value="' . $single_emp_type['id'] . '" selected="selected">' . $single_emp_type['name'] . '</option>';
																} else if (!$emp_type && $single_emp_type['id'] == '1') {
																	echo '<option value="' . $single_emp_type['id'] . '" selected="selected">' . $single_emp_type['name'] . '</option>';
																} else {
																	echo '<option value="' . $single_emp_type['id'] . '">' . $single_emp_type['name'] . '</option>';
																}
															} ?>
														</select>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-8">
														<select name="overtime_count" id="overtime_count">
															<option value="Not_Eligible" <?php if ($overtime_count == 'Not_Eligible') {
																								echo 'selected="selected"';
																							} ?>>Not Eligible</option>
															<option value="Eligible" <?php if ($overtime_count == 'Eligible') {
																							echo 'selected="selected"';
																						} ?>>Eligible</option>
														</select>
													</div>
											...
											<div class="col-md-6">
												<!-- <div class="row">
													...
													<div class="col-md-8">
														<input type="text" name="emp_present_salary" id="emp_present_salary" readonly="readonly" onkeypress="return isNumber(event);" value="<?php if ($emp_gross_salary) {
												...
												<div class="row">
													...
													<div class="col-md-8">
														<select name="attendance_required" id="attendance_required">
															<option value="Required" <?php if ($attendance_required == 'Required') {
																							echo 'selected="selected"';
																						} ?>>Required</option>
															<option value="Not_Required" <?php if ($attendance_required == 'Not_Required') {
																								echo 'selected="selected"';
																							} ?>>Not Required</option>
															<option value="Optional" <?php if ($attendance_required == 'Optional') {
																							echo 'selected="selected"';
																						} ?>>Optional</option>
														</select>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-8">
														<select name="logout_required" id="logout_required">
															<option value="Required" <?php if ($logout_required == 'Required') {
																							echo 'selected="selected"';
																						} ?>>Required</option>
															<option value="Not_Required" <?php if ($logout_required == 'Not_Required') {
																								echo 'selected="selected"';
																							} ?>>Not Required</option>
															<option value="Optional" <?php if ($logout_required == 'Optional') {
																							echo 'selected="selected"';
																						} ?>>Optional</option>
														</select>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-8">
														<select name="half_day_absent" id="half_day_absent">
															<option value="Not_Eligible" <?php if ($half_day_absent == 'Not_Eligible') {
																								echo 'selected="selected"';
																							} ?>>Not Eligible</option>
															<option value="Eligible" <?php if ($half_day_absent == 'Eligible') {
																							echo 'selected="selected"';
																						} ?>>Eligible</option>
														</select>
													</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-10">
														<!-- <input type="text" name="emp_weekly_holiday" id="emp_weekly_holiday"  value="<?php if ($emp_weekly_holiday) {
																																				echo $emp_weekly_holiday;
																																			} ?>"/>  -->
										...
										<div class="row">
											...
											<div class="col-md-2 heading_style" style="font-size: 13px;padding: 4.9px; ">
												<input type="checkbox" id="leave_category_system" name="leave_category_system" checked <?php //if($leave_cat_count && !$emp_total_leave){ echo 'checked="checked"'; } ?>> Category System
											</div>
										</div>
										-->
									...
									<div class="tabcontent" id="content_4">
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_1" id="emp_exp_position_1" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_1 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
											...
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" class="datepicker numbersOnly" placeholder="dd-mm-yyyy" name="emp_exp_datefrom_1" id="emp_exp_datefrom_1" value="<?php if ($emp_exp_datefrom_1) {
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_2" id="emp_exp_position_2" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_2 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_3" id="emp_exp_position_3" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_3 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_4" id="emp_exp_position_4" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_4 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_5" id="emp_exp_position_5" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_5 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_6" id="emp_exp_position_6" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_6 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_exp_position_7" id="emp_exp_position_7" data-placeholder="Choose a Position..." class="chosen-select">
													<option value=""></option>
													<?php foreach ($alljobtitle as $single_jobtitle) {
														if ($emp_exp_position_7 == $single_jobtitle['id']) {
															echo '<option value="' . $single_jobtitle['id'] . '" selected="selected">' . $single_jobtitle['name'] . '</option>';
														} else {
															echo '<option value="' . $single_jobtitle['id'] . '">' . $single_jobtitle['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_1" id="emp_comskill_level_1"  value="<?php if ($emp_comskill_level_1) {
																																																		echo $emp_comskill_level_1;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_1" id="emp_comskill_topics_1"  value="<?php if ($emp_comskill_topics_1) {
																																																			echo $emp_comskill_topics_1;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_1" id="emp_comskill_institute_1"  value="<?php if ($emp_comskill_institute_1) {
																																																				echo $emp_comskill_institute_1;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_1" id="emp_comskill_year_1" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_1) {
																																																											echo $emp_comskill_year_1;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_1" id="emp_comskill_duration_1"  value="<?php if ($emp_comskill_duration_1) {
																																																				echo $emp_comskill_duration_1;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_1" id="emp_comskill_results_1"  value="<?php if ($emp_comskill_results_1) {
																																																			echo $emp_comskill_results_1;
																																																		} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_2" id="emp_comskill_level_2"  value="<?php if ($emp_comskill_level_2) {
																																																		echo $emp_comskill_level_2;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_2" id="emp_comskill_topics_2"  value="<?php if ($emp_comskill_topics_2) {
																																																			echo $emp_comskill_topics_2;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_2" id="emp_comskill_institute_2"  value="<?php if ($emp_comskill_institute_2) {
																																																				echo $emp_comskill_institute_2;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_2" id="emp_comskill_year_2" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_2) {
																																																											echo $emp_comskill_year_2;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_2" id="emp_comskill_duration_2"  value="<?php if ($emp_comskill_duration_2) {
																																																				echo $emp_comskill_duration_2;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_2" id="emp_comskill_results_2"  value="<?php if ($emp_comskill_results_2) {
																																																			echo $emp_comskill_results_2;
																																																		} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_3" id="emp_comskill_level_3"  value="<?php if ($emp_comskill_level_3) {
																																																		echo $emp_comskill_level_3;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_3" id="emp_comskill_topics_3"  value="<?php if ($emp_comskill_topics_3) {
																																																			echo $emp_comskill_topics_3;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_3" id="emp_comskill_institute_3"  value="<?php if ($emp_comskill_institute_3) {
																																																				echo $emp_comskill_institute_3;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_3" id="emp_comskill_year_3" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_3) {
																																																											echo $emp_comskill_year_3;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_3" id="emp_comskill_duration_3"  value="<?php if ($emp_comskill_duration_3) {
																																																				echo $emp_comskill_duration_3;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_3" id="emp_comskill_results_3"  value="<?php if ($emp_comskill_results_3) {
																																																			echo $emp_comskill_results_3;
																																																		} ?>" /></div>
										</div>-->
										<!-- <div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_4" id="emp_comskill_level_4"  value="<?php if ($emp_comskill_level_4) {
																																																		echo $emp_comskill_level_4;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_4" id="emp_comskill_topics_4"  value="<?php if ($emp_comskill_topics_4) {
																																																			echo $emp_comskill_topics_4;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_4" id="emp_comskill_institute_4"  value="<?php if ($emp_comskill_institute_4) {
																																																				echo $emp_comskill_institute_4;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_4" id="emp_comskill_year_4" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_4) {
																																																											echo $emp_comskill_year_4;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_4" id="emp_comskill_duration_4"  value="<?php if ($emp_comskill_duration_4) {
																																																				echo $emp_comskill_duration_4;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_4" id="emp_comskill_results_4"  value="<?php if ($emp_comskill_results_4) {
																																																			echo $emp_comskill_results_4;
																																																		} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_5" id="emp_comskill_level_5"  value="<?php if ($emp_comskill_level_5) {
																																																		echo $emp_comskill_level_5;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_5" id="emp_comskill_topics_5"  value="<?php if ($emp_comskill_topics_5) {
																																																			echo $emp_comskill_topics_5;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_5" id="emp_comskill_institute_5"  value="<?php if ($emp_comskill_institute_5) {
																																																				echo $emp_comskill_institute_5;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_5" id="emp_comskill_year_5" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_5) {
																																																											echo $emp_comskill_year_5;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_5" id="emp_comskill_duration_5"  value="<?php if ($emp_comskill_duration_5) {
																																																				echo $emp_comskill_duration_5;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_5" id="emp_comskill_results_5"  value="<?php if ($emp_comskill_results_5) {
																																																			echo $emp_comskill_results_5;
																																																		} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_6" id="emp_comskill_level_6"  value="<?php if ($emp_comskill_level_6) {
																																																		echo $emp_comskill_level_6;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_6" id="emp_comskill_topics_6"  value="<?php if ($emp_comskill_topics_6) {
																																																			echo $emp_comskill_topics_6;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_6" id="emp_comskill_institute_6"  value="<?php if ($emp_comskill_institute_6) {
																																																				echo $emp_comskill_institute_6;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_6" id="emp_comskill_year_6" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_6) {
																																																											echo $emp_comskill_year_6;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_6" id="emp_comskill_duration_6"  value="<?php if ($emp_comskill_duration_6) {
																																																				echo $emp_comskill_duration_6;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_6" id="emp_comskill_results_6"  value="<?php if ($emp_comskill_results_6) {
																																																			echo $emp_comskill_results_6;
																																																		} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_level_7" id="emp_comskill_level_7"  value="<?php if ($emp_comskill_level_7) {
																																																		echo $emp_comskill_level_7;
																																																	} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_topics_7" id="emp_comskill_topics_7"  value="<?php if ($emp_comskill_topics_7) {
																																																			echo $emp_comskill_topics_7;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_institute_7" id="emp_comskill_institute_7"  value="<?php if ($emp_comskill_institute_7) {
																																																				echo $emp_comskill_institute_7;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_year_7" id="emp_comskill_year_7" onkeypress="return isNumber(event);" value="<?php if ($emp_comskill_year_7) {
																																																											echo $emp_comskill_year_7;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_duration_7" id="emp_comskill_duration_7"  value="<?php if ($emp_comskill_duration_7) {
																																																				echo $emp_comskill_duration_7;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_comskill_results_7" id="emp_comskill_results_7"  value="<?php if ($emp_comskill_results_7) {
																																																			echo $emp_comskill_results_7;
																																																		} ?>" /></div>
										</div> -->
										<!-- training end										 -->
									</div>
									...
									<div class="tabcontent" id="content_5">
										...
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_1" id="emp_education_level_1">
													...
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_1 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_2" id="emp_education_level_2">
													<option value="">Select Level</option>
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_2 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_3" id="emp_education_level_3">
													<option value="">Select Level</option>
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_3 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_4" id="emp_education_level_4">
													<option value="">Select Level</option>
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_4 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
										...
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_5" id="emp_education_level_5">
													<option value="">Select Level</option>
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_5 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
										...
										<!-- 										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_6" id="emp_education_level_6">
													<option value="">Select Level</option>
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_6 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_degree_6" id="emp_education_degree_6"  value="<?php if ($emp_education_degree_6) {
																																																			echo $emp_education_degree_6;
																																																		} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_major_6" id="emp_education_major_6"  value="<?php if ($emp_education_major_6) {
																																																			echo $emp_education_major_6;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_institute_6" id="emp_education_institute_6" value="<?php if ($emp_education_institute_6) {
																																																				echo $emp_education_institute_6;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_year_6" id="emp_education_year_6" onkeypress="return isNumber(event);" value="<?php if ($emp_education_year_6) {
																																																											echo $emp_education_year_6;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_results_6" id="emp_education_results_6"  value="<?php if ($emp_education_results_6) {
																																																				echo $emp_education_results_6;
																																																			} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_education_level_7" id="emp_education_level_7">
													<option value="">Select Level</option>
													<?php foreach ($allqualification as $single_qualification) {
														if ($emp_education_level_7 == $single_qualification['id']) {
															echo '<option value="' . $single_qualification['id'] . '" selected="selected">' . $single_qualification['name'] . '</option>';
														} else {
															echo '<option value="' . $single_qualification['id'] . '">' . $single_qualification['name'] . '</option>';
														}
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_degree_7" id="emp_education_degree_7"  value="<?php if ($emp_education_degree_7) {
																																																			echo $emp_education_degree_7;
																																																		} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_major_7" id="emp_education_major_7"  value="<?php if ($emp_education_major_7) {
																																																			echo $emp_education_major_7;
																																																		} ?>" /></div>
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_institute_7" id="emp_education_institute_7" value="<?php if ($emp_education_institute_7) {
																																																				echo $emp_education_institute_7;
																																																			} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_year_7" id="emp_education_year_7" onkeypress="return isNumber(event);" value="<?php if ($emp_education_year_7) {
																																																											echo $emp_education_year_7;
																																																										} ?>" /></div>
											<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_education_results_7" id="emp_education_results_7"  value="<?php if ($emp_education_results_7) {
																																																				echo $emp_education_results_7;
																																																			} ?>" /></div>
										</div> -->
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_1" id="emp_language_name_1" value="<?php if ($emp_language_name_1) {
																																																	echo $emp_language_name_1;
																																																} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_1" id="emp_language_reading_1">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_1 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_1 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_1 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_1" id="emp_language_writing_1">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_1 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_1 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_1 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_1" id="emp_language_speaking_1">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_1 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_1 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_1 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_1" id="emp_language_listening_1">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_1 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_1 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_1 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_2" id="emp_language_name_2" value="<?php if ($emp_language_name_2) {
																																																	echo $emp_language_name_2;
																																																} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_2" id="emp_language_reading_2">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_2 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_2 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_2 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_2" id="emp_language_writing_2">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_2 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_2 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_2 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_2" id="emp_language_speaking_2">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_2 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_2 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_2 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_2" id="emp_language_listening_2">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_2 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_2 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_2 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_3" id="emp_language_name_3" value="<?php if ($emp_language_name_3) {
																																																	echo $emp_language_name_3;
																																																} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_3" id="emp_language_reading_3">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_3 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_3 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_3 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_3" id="emp_language_writing_3">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_3 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_3 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_3 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_3" id="emp_language_speaking_3">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_3 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_3 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_3 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_3" id="emp_language_listening_3">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_3 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_3 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_3 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
										...
										<!-- <div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_4" id="emp_language_name_4"  value="<?php if ($emp_language_name_4) {
																																																		echo $emp_language_name_4;
																																																	} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_4" id="emp_language_reading_4">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_4 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_4 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_4 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_4" id="emp_language_writing_4">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_4 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_4 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_4 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_4" id="emp_language_speaking_4">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_4 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_4 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_4 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_4" id="emp_language_listening_4">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_4 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_4 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_4 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_5" id="emp_language_name_5"  value="<?php if ($emp_language_name_5) {
																																																		echo $emp_language_name_5;
																																																	} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_5" id="emp_language_reading_5">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_5 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_5 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_5 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_5" id="emp_language_writing_5">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_5 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_5 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_5 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_5" id="emp_language_speaking_5">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_5 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_5 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_5 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_5" id="emp_language_listening_5">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_5 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_5 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_5 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_6" id="emp_language_name_6"  value="<?php if ($emp_language_name_6) {
																																																		echo $emp_language_name_6;
																																																	} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_6" id="emp_language_reading_6">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_6 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_6 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_6 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_6" id="emp_language_writing_6">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_6 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_6 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_6 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_6" id="emp_language_speaking_6">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_6 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_6 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_6 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_6" id="emp_language_listening_6">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_6 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_6 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_6 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_language_name_7" id="emp_language_name_7"  value="<?php if ($emp_language_name_7) {
																																																		echo $emp_language_name_7;
																																																	} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_reading_7" id="emp_language_reading_7">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_reading_7 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_reading_7 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_reading_7 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_writing_7" id="emp_language_writing_7">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_writing_7 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_writing_7 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_writing_7 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_speaking_7" id="emp_language_speaking_7">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_speaking_7 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_speaking_7 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_speaking_7 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_language_listening_7" id="emp_language_listening_7">
													<option value="">Select</option>
													<option value="High" <?php if ($emp_language_listening_7 == 'High') {
																				echo 'selected="selected"';
																			} ?>>High</option>
													<option value="Medium" <?php if ($emp_language_listening_7 == 'Medium') {
																				echo 'selected="selected"';
																			} ?>>Medium</option>
													<option value="Low" <?php if ($emp_language_listening_7 == 'Low') {
																			echo 'selected="selected"';
																		} ?>>Low</option>
												</select>
											</div>
									...
									<div class="tabcontent" id="content_8">
										...
										<!-- 	<div class="row">
												<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_name_4" id="emp_reference_name_4"  value="<?php if ($emp_reference_name_4) {
																																																			echo $emp_reference_name_4;
																																																		} ?>" /></div>
												<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_position_4" id="emp_reference_position_4"  value="<?php if ($emp_reference_position_4) {
																																																					echo $emp_reference_position_4;
																																																				} ?>" /></div>
												<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_org_4" id="emp_reference_org_4"  value="<?php if ($emp_reference_org_4) {
																																																			echo $emp_reference_org_4;
																																																		} ?>" /></div>
												<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_address_4" id="emp_reference_address_4" value="<?php if ($emp_reference_address_4) {
																																																				echo $emp_reference_address_4;
																																																			} ?>" /></div>
												<div class="col-md-2 custom_width_10666667" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_phone_4" id="emp_reference_phone_4"  value="<?php if ($emp_reference_phone_4) {
																																																									echo $emp_reference_phone_4;
																																																								} ?>" /></div>
												<div class="col-md-1 custom_width_13666667" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_email_4" id="emp_reference_email_4"  value="<?php if ($emp_reference_email_4) {
																																																									echo $emp_reference_email_4;
																																																								} ?>" /></div>
												<div class="col-md-1" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_reference_relation_4" id="emp_reference_relation_4"  value="<?php if ($emp_reference_relation_4) {
																																																					echo $emp_reference_relation_4;
																																																				} ?>" /></div>
											</div> -->
										<div class="row">
											<div class="col-md-12 heading_style">
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_1" id="emp_dependent_relation_1">
													...
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_1 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
													} ?>
												</select>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_2" id="emp_dependent_relation_2">
													<option value="">Select</option>
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_2 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
										...
										<div class="row">
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_3" id="emp_dependent_relation_3">
													<option value="">Select</option>
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_3 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
										...
										<div class="row">
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_4" id="emp_dependent_relation_4">
													<option value="">Select</option>
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_4 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
										...
										<div class="row">
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_5" id="emp_dependent_relation_5">
													<option value="">Select</option>
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_5 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
										...
										<!-- <div class="row">
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_dependent_name_6" id="emp_dependent_name_6"  value="<?php if ($emp_dependent_name_6) {
																																																		echo $emp_dependent_name_6;
																																																	} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" class="datepicker numbersOnly" placeholder="dd-mm-yyyy" name="emp_dependent_dob_6" id="emp_dependent_dob_6"  value="<?php if ($emp_dependent_dob_6) {
																																																																echo $emp_dependent_dob_6;
																																																															} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_6" id="emp_dependent_relation_6">
													<option value="">Select</option>
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_6 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_dependent_nomtype_6" id="emp_dependent_nomtype_6" value="<?php if ($emp_dependent_nomtype_6) {
																																																			echo $emp_dependent_nomtype_6;
																																																		} ?>" /></div>
										</div>
										<div class="row">
											<div class="col-md-4" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_dependent_name_7" id="emp_dependent_name_7"  value="<?php if ($emp_dependent_name_7) {
																																																		echo $emp_dependent_name_7;
																																																	} ?>" /></div>
											<div class="col-md-2" style="padding-right: 2px;  padding-left: 2px;"><input type="text" class="datepicker numbersOnly" placeholder="dd-mm-yyyy" name="emp_dependent_dob_7" id="emp_dependent_dob_7"  value="<?php if ($emp_dependent_dob_7) {
																																																																echo $emp_dependent_dob_7;
																																																															} ?>" /></div>
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;">
												<select name="emp_dependent_relation_7" id="emp_dependent_relation_7">
													<option value="">Select</option>
													<?php foreach ($allrelative as $single_relative) {
														if ($emp_dependent_relation_7 == $single_relative['id']) {
															echo '<option value="' . $single_relative['id'] . '" selected="selected">' . $single_relative['name'] . '</option>';
														} else {
															echo '<option value="' . $single_relative['id'] . '">' . $single_relative['name'] . '</option>';
														}
											...
											<div class="col-md-3" style="padding-right: 2px;  padding-left: 2px;"><input type="text" name="emp_dependent_nomtype_7" id="emp_dependent_nomtype_7" value="<?php if ($emp_dependent_nomtype_7) {
																																																			echo $emp_dependent_nomtype_7;
																																																		} ?>" /></div>
										</div> -->
									</div>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $increment_amount; ?></td>
						<td><?php echo $increment_percentage; ?></td>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<input type="text" name="salaryedit[emp_basic_salary]" id="popup_emp_basic_salary" onkeypress="return isNumber(event);" value="<?php if ($emp_basic_salary) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_medical_allowance]" id="popup_emp_medical_allowance" onkeypress="return isNumber(event);" value="<?php if ($emp_medical_allowance) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_telephone_allowance]" id="popup_emp_telephone_allowance" onkeypress="return isNumber(event);" value="<?php if ($emp_telephone_allowance) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_provident_fund_allowance]" id="popup_emp_provident_fund_allowance" onkeypress="return isNumber(event);" value="<?php if ($emp_provident_fund_allowance) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_other_allowance]" id="popup_emp_other_allowance" onkeypress="return isNumber(event);" value="<?php if ($emp_other_allowance) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_festival_bonus]" id="popup_emp_festival_bonus" onkeypress="return isNumber(event);" value="<?php if ($emp_festival_bonus) {
				...
				<div class="col-md-6">
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_house_rent]" id="popup_emp_house_rent" onkeypress="return isNumber(event);" value="<?php if ($emp_house_rent) {
																																							echo $emp_house_rent;
																																						} ?>"/>        
						</div>
					</div>	
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_conveyance]" id="popup_emp_conveyance" onkeypress="return isNumber(event);" value="<?php if ($emp_conveyance) {
																																							echo $emp_conveyance;
																																						} ?>"/>        
						</div>
					</div>	
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_special_allowance]" id="popup_emp_special_allowance" onkeypress="return isNumber(event);" value="<?php if ($emp_special_allowance) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_transport_allowance]" id="popup_emp_transport_allowance" onkeypress="return isNumber(event);" value="<?php if ($emp_transport_allowance) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_performance_bonus]" id="popup_emp_performance_bonus" onkeypress="return isNumber(event);" value="<?php if ($emp_performance_bonus) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_total_benifit]" id="popup_emp_total_benifit" onkeypress="return isNumber(event);" value="<?php if ($emp_total_benifit) {
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_salary_increment_amount]" id="popup_emp_salary_increment_amount" onkeypress="return isNumber(event);" value="<?php if ($emp_salary_increment_amount) {
																																														echo $emp_salary_increment_amount;
																																													} ?>"/>        
						</div>
					</div>	
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_increment_percentage]" id="popup_emp_increment_percentage" value="<?php if ($emp_increment_percentage) {
																																			echo $emp_increment_percentage;
																																		} ?>"/>        
						</div>
					</div>																									
				</div>									
				<div class="col-md-6">
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_increment_date]" id="popup_emp_increment_date" class="datepicker numbersOnly" placeholder="dd-mm-yyyy" value="<?php if ($emp_increment_date) {
																																														echo $emp_increment_date;
																																													} else {
																																														echo $now;
																																													} ?>"/>        
						</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						<div class="col-md-4 bgcolor_D8D8D8" style="font-size: 11px;">Provident/Welfare Fund</div>
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_provident_fund_deduction]" id="popup_emp_provident_fund_deduction" onkeypress="return isNumber(event);" value="<?php if ($emp_provident_fund_deduction) {
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_total_deduction]" id="popup_emp_total_deduction" onkeypress="return isNumber(event);" value="<?php if ($emp_total_deduction) {
				...
				<div class="col-md-6">
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="salaryedit[emp_other_deduction]" id="popup_emp_other_deduction" onkeypress="return isNumber(event);" value="<?php if ($emp_other_deduction) {
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="text" name="salaryedit[emp_gross_salary]" id="popup_emp_gross_salary" onkeypress="return isNumber(event);" value="<?php if ($emp_gross_salary) {
																																							echo $emp_gross_salary;
																																						} ?>"/>        
					</div>
				</div>													
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="text" name="salaryedit[emp_yearly_paid]" id="popup_emp_yearly_paid" onkeypress="return isNumber(event);" value="<?php if ($emp_yearly_paid) {
