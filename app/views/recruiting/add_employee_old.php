				...
				<div class="row">
					...
					<?php endif; ?>
						...
						<form action="<?php echo base_url(); ?>addprofile/do_upload" method="post" class="myForm" id="myForm" name="myForm" onSubmit="return validate();" enctype="multipart/form-data">
							...
							<div class="row ">
								<div class="col-md-12">
									<input type="submit" id="add_profile_btn" value="Save <?php if ($content_id) { echo 'Changes'; }?>">
								...
								<div class="tabs">
									...
									<div class="tabcontent" id="content_1">
															...
															<div class="col-md-8">
																<select name="emp_department" id="emp_department" class="chosen-select">
																	...
																	<?php foreach ($departments as $department) { ?>
																		<option value="<?php echo $department['tid']; ?>" <?php if ($department['tid'] == $emp_department) {
																																echo "selected";
										...
										<div class="row">
											...
											<!-- <input type="checkbox" id="leave_category_system" name="leave_category_system" <?php //if($leave_cat_count && !$emp_total_leave){ echo 'checked="checked"'; } 
																																?>> Category System -->
											<!-- </div>																						 -->
										</div>
										...
										<!-- 										<div class="category_leave_area" style="<?php //if($leave_cat_count && !$emp_total_leave){ echo 'display:block;'; }else{ echo 'display:none;';} 
																																?>">				
										<div class="row">
											<div class="col-md-6">
												<?php
												...
												?>
													<div class="row">
														<div class="col-md-4 bgcolor_D8D8D8"><?php //echo $leave_level; 
																								?></div>
														<div class="col-md-8">
															<input type="text" name="annual_leave[<?= $leave_tid ?>]" id="<?= $leave_machine_name ?>"  onkeypress="return isNumber(event);" value="<?php if ($previous_leave) {
