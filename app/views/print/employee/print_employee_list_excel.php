...
<html lang="en">
    <head>
        ...
        <?php
                ...
                ?>
        <body onload="tableToExcel('report',  'Employee List', 'employee_list_<?php echo $nowdate; ?>.xls')" class="logged-in dashboard current-page print-attendance">
        <!-- Page Content -->  
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <a href="#"  class="" style="width:150px;" onclick="tableToExcel('report',  'Employee List', 'employee_list_<?php echo $nowdate; ?>.xls')" ><span class="glyphicon glyphicon-file"></span>Export to Excel</a>
<br/>
                  <div id="report">
                <div class="row" style="font-weight:normal">
                    ...
                    <div class="col-md-2" style="float:left;text-align: left;width:620px;">
                      ...
                      if($emp_division){
                       ...
                       echo $empDivision['name']; 
                      }else{
                          echo "IIDFC Securities Limited";
                      }
                      ?>
                        </h1>
                    ...
                    <!--<div class="col-md-2" style="float:right;width:120px;" > <img src="<?php echo base_url(); ?>resources/images/logo.png" style="width:100px;height:100px;display:inline;" alt="" id="logo-img"/></div>-->
                      ...
                      <br/>
                      <div><span style="float:right">Downloaded Time: <?php echo $now; ?></span></div>  
                                        ...
                                        foreach ($page_query as $sigle_content) {
                                            ...
                                            <tr>                                   
                                                ...
                                                <td><?php echo $joining_date; ?></td>
                                                 <?php if($view_employee_date_of_birth['status']==1){?>
                                                <td><?php echo $sigle_content['dob']; ?></td>
                                                 <?php }if($view_employee_age['status']==1){?>
                                                <td>
 ...
 ?>
    ...
    <span style="padding-left:8px;font-family:Verdana, Geneva, sans-serif"></span>' +
        ...
        popupWin.document.write('<html><head><title>Cash Summary </title>\n\
    \n\
    \n\
    \n\
    \n\
