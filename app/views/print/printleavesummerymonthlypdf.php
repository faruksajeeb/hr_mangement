    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row under-header-bar text-center">
                <h1 style="font-size:20px;font-weight:bold">Monthly Leave Summery Reports</h1>
            </div>
            <div class="emp_info">
                <div class="row">
                    <div class="col-md-1" style="width:110px;">Company Name:</div>
                    <div class="col-md-9" style="width:720px;"><?php echo $defsultdivision_name; ?></div>
                    <div class="col-md-1" style="width:35px;">Date Range:</div>
                    <div class="col-md-1" style="width:78px;"><?php echo $default_start_date." to ".$default_end_date; ?></div>
                </div>
                <div class="row">
                    <div class="col-md-1" style="width:110px;">Short Name:</div>
                    <div class="col-md-9" style="width:720px;"><?php echo $defsultdivision_shortname; ?></div>
                    <div class="col-md-1" style="width:35px;">Time:</div>
                    <div class="col-md-1" style="width:78px;"><?php echo $nowtime; ?></div>
                </div>
            </div>
            <div class="wrapper">
                <div class="row">
                            ...
                            <tbody>
                                ...
                                foreach ($emp_codes as $single_code) {
                                    ...
                                    foreach ($total_leave_spent_query as $single_spent_leave) {
                                        ...
                                        $leave_spent_date .= "<ul>" . $single_spent_leave['leave_start_date'] . "</ul>,";
                                    }
                                ...
                                ?>
                                    <tr style="border:1px solid #000;border-bottom:none;border-left:none;border-right:none;">
                                        ...
                                        <td><?php //print $available_leave_grant_total; 
                                            ?></td>
                                    </tr>
