    ...
    <div class="container-fluid">
      ...
      $now = date("d-m-Y H:i:s", $servertime);
            ...
            <div class="row under-header-bar text-center"> 
              <h1 style="font-size:20px;font-weight:bold">Employee Daily Early Out Reports<br>Log Date:<?php print $default_date; ?></h1>         
            </div> 
            <div class="row">
                      ...
                      if ($holiday_exist) {
                        ...
                        $holiday_name_info = $this->taxonomy->getTaxonomyBytid($holiday_type_tid);
                              ...
                              <tr style="margin-bottom:10px;">
                                <td width="53%"><span style="font-weight: bold; font-style: italic;border-bottom:2px solid #000">Total No of Early Out <?php print $early_counter; ?></span></td>
