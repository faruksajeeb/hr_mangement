    ...
    <div id="page-content-wrapper">
      ...
      $now = date("d-m-Y H:i:s", $servertime);
            ...
            <div class="row under-header-bar text-center"> 
                <h1 style="font-size:20px;font-weight:bold">Employee Daily Attendance Reports<br>Log Date:<?php print $default_date; ?></h1>         
          </div> 
        <div class="row">
...
//                }             
                   ...
                   // print_r($has_log_attendance_error);
                    ...
                    $emp_informed_info = $this->db->query("SELECT presence_status,logout_status,reason,remarks FROM emp_informed WHERE content_id=$emp_content_id AND attendance_date='$default_date' ORDER BY id DESC")->row_array();
...
//                        $leave_exist = $this->db->query("SELECT leave_type,justification FROM emp_leave WHERE content_id='$emp_content_id' AND leave_start_date='$default_date' ORDER BY id DESC")->row_array();
                            $leave_exist = $this->db->query("SELECT el.leave_type,el.justification,t.name as leave_name "
                                            ...
                                            . "AND el.leave_start_date='$default_date' ORDER BY el.id DESC")->row_array();
                  ...
                  ?>
                  <tr style="border:1px solid #000;border-bottom:none;border-left:none;border-right:none;"> <td><?php print $default_date; ?></td>
...
<table width="100%" style="vertical-align: bottom; font-family: serif; font-size: 12pt; 
    ...
    <td width="53%"><span style="font-weight: bold; font-style: italic;border-bottom:2px solid #000">Total No of Late <?php print $late_counter; ?>, Early Out <?php print $early_counter; ?> and Half Day Absent <?php print $absent_halfday_counter; ?></span></td>
