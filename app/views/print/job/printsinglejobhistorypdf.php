...
<head>
  ...
  <title>Employment History of <?php print $default_emp['emp_name']; ?></title>
  <?php
    ...
    <div class="container-fluid">
      ...
      $nowtime = date("H:i:s a", $servertime);
            ...
            <div class="row under-header-bar text-center"> 
              <h1 style="font-size:20px;font-weight:bold">Employment History Reports</h1>         
            </div> 
        <div class="emp_info">
          <div class="row">
