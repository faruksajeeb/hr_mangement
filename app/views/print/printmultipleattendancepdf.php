...
foreach ($emp_codes as $single_code) {
  ...
  $default_emp=$this->search_field_emp_model->getallsearch_table_contentByid($content_id);
  ...
  $emp_details_info=$this->search_field_emp_model->getallsearch_table_contentByid($content_id); 
   if($counter>1){
  echo "<pagebreak />";
  }
?>
          ...
          <div class="row"> 
            ...
            <div class="col-md-9" style="width:250px;"><?php 
              ...
              <div class="col-md-9" style="width:180px;" ><?php 
                $total_leave_query=$this->emp_leave_model->getemp_sumleavetotal($content_id, $lastdateofattendance);
              ...
              <div class="row">
                ...
                <div class="col-md-9" style="width:180px;font-size: 10px;"><?php 
                 ...
                 date_default_timezone_set('Asia/Dhaka');
                 $now = time();
          // $interval = date_diff(date_create(), date_create($joining_date_reversed));
          // echo $interval->format("%Y Year, %M Months, %d Days");
          // echo timespan($jo, $now);
                 ...
                 $left_or_termineted=$default_emp['type_of_employee'];
                      if($left_or_termineted==153 || $left_or_termineted==473){
                        $left_or_termineted_data =$this->emp_job_history_model->getemp_last_job_history($content_id);
                    ...
                    if (!$logout_time && $login_time && $login_time >= "16:00:00") {
                      ...
                      <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-1" style="width:68px;border-top:2px solid #000;font-weight:bold"><?php
                         ...
                         <htmlpagefooter name="MyFooter<?php print $counter; ?>">
...
<td width="0%" align="center" style="font-weight: bold; font-style: italic;"></td>
                      ...
                      <sethtmlpagefooter name="MyFooter<?php print $counter; ?>" value="on" />
                    </div>
                  </div>              
                </div>
              </div>
