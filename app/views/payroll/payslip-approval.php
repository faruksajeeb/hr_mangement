...
<head>
    ...
    <title>HRMS- Payslip Approval</title>
    <!--chosen-->
    <?php
    ...
    <script>
        $(document).ready(function() {
            ...
            // Approved multiple -----------------------
            $(".approved_multiple").on('click', function(e) {
                    ...
                    $("#dialog-approved").dialog({
                        ...
                        buttons: {
                            "Yes": function() {
                                ...
                                //alert('thanks');
                                $.ajax({
                                    url: '<?php echo base_url(); ?>payroll/approvedMultiplePayslip',
                                    type: 'post',
            ...
            // Cancel Approved multiple -----------------------
            $(".cancel_approved_multiple").on('click', function(e) {
                e.preventDefault(); //The preventDefault() method will prevent the link above from following the URL.
                var checkValues = $('.check-single:checked').map(function() {
                    return $(this).val();
                }).get();
                    ...
                    $("#dialog-cancel-approved").dialog({
                        ...
                        buttons: {
                            "Yes": function() {
                                ...
                                //alert('thanks');
                                $.ajax({
                                    url: '<?php echo base_url(); ?>payroll/cancelApprovedMultiplePayslip',
                                    type: 'post',
                                    data: 'payslip_id=' + checkValues
                                }).done(function(data) {
                                    alert(data);
...
<body class="logged-in dashboard current-page add-division">
                    ...
                    <div class="col-md-6 col-xs-12 add-form">
                        <div class="row add-form-heading">
                            <div class="col-md-12 ">
                                ...
                                <i class="fas fa-money-check-alt " style="font-size:20px"></i> Approve Payslip
                            </div>
                        </div>
            ...
            <div class="row">
                        ...
                        <option value="cheque">Cheque</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <div class="row">
                                        <div class="col-md-12"><a href="pay-slip-payment" class="btn btn-sm btn-info">Payslip Payment >></a></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-12">
                                        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if ($paySlips) {
                        ?>
                            <a href="#" style="visibility: hidden; margin-right:5px;" class='btn btn-md btn-success pull-left approved_multiple' rel="tooltip">
                                <i class="fa fa-trash-o">Approved Selected</i>
                            </a>
                            <a href="#" style="visibility: hidden" class='btn btn-md btn-danger pull-left cancel_approved_multiple' rel="tooltip">
                                <i class="fa fa-trash-o">Cancel Approval (Selected)</i>
                            </a>
                                ...
                                <table style="width:100%" id="example">
                                    ...
                                    ?>
                                        <tr class="checked checked-<?php echo $paySlip->id; ?>">
                                            ...
                                            <td><?php echo $paySlip->pay_from; ?></td>
                                            <td><?php echo $paySlip->pay_to; ?></td>
                                            ...
                                            <td style="width:350px;text-align: center">
                                                ...
                                                <?php if ($paySlip->approve_status == 0 && $paySlip->checked == 1) { ?>
                                                    <a title="Approved payslip" href="<?php echo site_url(); ?>pay-slip-approval/<?php echo $paySlip->id; ?>/approved" class=" btn btn-xs btn-success"> Approved</a>
                                                <?php } ?>
                                                <?php if ($paySlip->approve_status == 1) { ?>
                                                    <a title="Cancel Approval" href="<?php echo site_url(); ?>pay-slip-approval/<?php echo $paySlip->id; ?>/cancel_approved" class=" btn btn-xs btn-danger">Cancel Approval</a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php
                                    ...
                                    ?>
                                    <tr style="font-weight: bold; text-align: right; background: #D2691E;color:#FFF;">
    ...
    <!-- /#wrapper -->
    <div style="display:none" id="dialog-approved" title="Alert!">
        <p>
            <span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>
            These payslips will be approved. Are you sure?
        </p>
    </div>
    <div style="display:none" id="dialog-cancel-approved" title="Alert!">
        <p>
            <span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>
            These payslips approval will be canceled. Are you sure?
        </p>
    </div>
    <script>
        function PrintDiv() {
