<div class="modal-content">
    ...
    <div class="modal-header">
        ...
        <h3 class="modal-title"><?php echo isset($edit_data) ? 'Edit' : 'Add'; ?> Festival Bonus</h3>
    </div>
    <form action="<?php echo site_url('save-festival-bonus') ?>" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit"id="submit-btn"  class="btn btn-sm btn-primary submit-btn" style="width:100px"><?php echo isset($edit_data) ? 'Save Changes' : 'Submit'; ?> </button>
        </div>
    </form>
</div>
<script>
