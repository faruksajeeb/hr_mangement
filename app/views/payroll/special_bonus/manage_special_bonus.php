...
<head>
    ...
    <title>HRMS | Special Bonus</title>
    <!--chosen-->
...
<body class="logged-in dashboard current-page add-division">
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 ">
                        ...
                        $msg = null;
                        ?>
                        <a href="" class="btn custom-btn btn-warning pull-right addSpecialBonus" data-toggle="modal" data-target="#addSpecialBonus" id="add_special_bonus"> <i class="fa fa-plus"></i> Add Special Bonus</a>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $k => $val) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn custom-btn btn-sm btn-default edit_special_bonus" id='<?php echo $val->id; ?>' href="#"><span class="glyphicon glyphicon-edit"> </span> Edit</a>
                        ...
                        <!-- Add/Edit Modal -->
                        <div class="modal fade" id="addSpecialBonus" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_special_bonus').click(function(e) {
                $.ajax({
                    url: url_prefix + "add-special-bonus",
                    dataType: 'html',
                    type: 'GET',
                    data: {
                    ...
                    $("#addSpecialBonus").modal("show");

                });
            });
            $(document).on("click", ".edit_special_bonus", function(event) {
                edit_id = $(this).attr('id');
                if (edit_id) {
                    $.ajax({
                        url: url_prefix + "edit-special-bonus",
                        dataType: 'html',
                        type: 'GET',
                        data: {
                            edit_id: edit_id
