...
<head>
    ...
    <title>HRMS | Performance Bonus</title>
    <!--chosen-->
...
<body class="logged-in dashboard current-page add-division">
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 ">
                        ...
                        $msg = null;
                        ?>
                        <a href="" class="btn custom-btn btn-warning pull-right addPerformanceBonus" data-toggle="modal" data-target="#addPerformanceBonus" id="add_performance_bonus"> <i class="fa fa-plus"></i> Add Performance Bonus</a>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $k => $val) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn custom-btn btn-sm btn-default edit_performance_bonus" id='<?php echo $val->id; ?>' href="#"><span class="glyphicon glyphicon-edit"> </span> Edit</a>
                        ...
                        <!-- Add/Edit Modal -->
                        <div class="modal fade" id="addPerformanceBonus" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_performance_bonus').click(function(e) {
                $.ajax({
                    url: url_prefix + "add-performance-bonus",
                    dataType: 'html',
                    type: 'GET',
                    data: {
                    ...
                    $("#addPerformanceBonus").modal("show");

                });
            });
            $(document).on("click", ".edit_performance_bonus", function(event) {
                edit_id = $(this).attr('id');
                if (edit_id) {
                    $.ajax({
                        url: url_prefix + "edit-performance-bonus",
                        dataType: 'html',
                        type: 'GET',
                        data: {
                            edit_id: edit_id
