<div class="modal-content">
    ...
    <form action="<?php echo site_url('save-salary') ?>" method="POST">
        <input type="hidden" name="edit_id" id="edit_id" value="<?php if(isset($edit_data)){ echo $edit_data->id;}?>"/>
        <?php if ($error) : ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php } ?>
                        <select name="content_id" id="content_id" <?php if(isset($edit_data)){ echo "disabled";}?> data-placeholder="Choose a staff..." class="chosen-select">
                            <option value="">Choose a staff...</option>
                            <?php foreach ($active_employees as $key => $empVal) : ?>
                                <option value="<?php echo $empVal->content_id; ?>" <?php if(isset($edit_data) && ($edit_data->content_id==$empVal->content_id)) { echo "selected='selected'";} ?>><?php echo $empVal->emp_id . ' | ' . $empVal->emp_name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="grade_id" id="grade_id" data-placeholder="Choose a staff..." class="chosen-select grade_id">
                            ...
                            <?php foreach ($salary_grades as $key => $gradeVal) : ?>
                                <option value="<?php echo $gradeVal->id; ?>" <?php if(isset($edit_data) && ($edit_data->grade_id==$gradeVal->id)) { echo "selected='selected'";} ?>><?php echo $gradeVal->grade_name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <?php foreach ($salary_earning_heads as $earnHead) : ?>
                            <div class="form-group">
                                ...
                                <input class="form-control salary_allowance_head" value="<?php echo set_value($earnHead->short_name) ?>" type="text" name="<?php echo $earnHead->short_name; ?>" id="<?php echo $earnHead->short_name; ?>">
                            </div>
                        <?php endforeach; ?>
                        <!-- <div class="form-group">
                                                        <label>DA(40%)</label>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <?php foreach ($salary_deduction_heads as $deductHead) : ?>
                            <div class="form-group">
                                ...
                                <input class="form-control salary_deduction_head" type="text" name="<?php echo $deductHead->short_name; ?>" id="<?php echo $deductHead->short_name; ?>">
                            </div>
                        <?php endforeach; ?>
                        <!-- <div class="form-group">
                                                        <label>TDS</label>
                ...
                <div class="col-md-12">
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input readonly name="gross_salary" id="gross_salary" class="form-control" type="text">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Net Salary *</label>
                            <input readonly name="net_salary" id="net_salary" class="form-control" type="text">
                        </div>
                    </fieldset>
                </div>
            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="bank_id" id="bank_id" class="chosen-select">
                                ...
                                <?php foreach ($banks as $val) : ?>
                                    <option value="<?php echo $val->id; ?>" <?php if(isset($edit_data) && ($edit_data->bank_id==$val->id)) { echo "selected='selected'";} ?>><?php echo $val->name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Branch Name</label>
                            <input class="form-control" type="text" name="branch_name" id="branch_name" value="<?php if(isset($edit_data)){ echo $edit_data->branch_name; } ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label>A/C No.</label>
                            <input class="form-control" type="text" name="account_no" id="account_no" value="<?php if(isset($edit_data)){ echo $edit_data->bank_account_no; } ?>">
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <select required name="pay_type_id" id="pay_type_id" class="chosen-select">
                                ...
                                <?php foreach ($pay_types as $val) : ?>
                                    <option value="<?php echo $val->id; ?>" <?php if(isset($edit_data) && ($edit_data->pay_type_id==$val->id)) { echo "selected='selected'";} ?>><?php echo $val->name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="comments">Comments</label>
                            <textarea name="comments" id="comments" cols="30" rows="3"><?php if(isset($edit_data)){ echo $edit_data->comments; } ?></textarea>
                        </div>
                    </fieldset>
                </div>
            </div>
