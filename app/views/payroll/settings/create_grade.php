                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="absent_deduction_type" id="absent_deduction_type" class="form-control" required>
                                                    ...
                                                    <option value="as_per_man_day" <?php if (isset($gradeData)) {
                                                                                    ...
                                                                                    }else{ echo set_select('absent_deduction_type','as_per_man_day'); } ?>>As per man day</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <table class="table table-striped table-sm">
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <input style="float:left;margin-right:5px;" class="largerCheckbox component_id" type="checkbox" name="component_id[<?php echo $key; ?>]" id="component_id_<?php echo $earn_head->id; ?>" value="<?php echo $earn_head->id; ?>" <?php echo ($edited_id) ? 'checked="checked"' : ''; ?>  <?php echo set_checkbox('component_id['.$key.']', $earn_head->id); ?> >
                                                    <label class="" for="component_id_<?php echo $earn_head->id; ?>"><?php echo $earn_head->head_name; ?></label>

                                                </td>
                                                <td>
                                                    <select name="salary_component_amount_type[<?php echo $key; ?>]" id="salary_component_amount_type_<?php echo $earn_head->id; ?>" class="form-control salary_component_amount_type">
                                                        <option value="">Select One</option>
                                                        <option value="fixed" <?php echo ($component_amount_type == 'fixed') ? 'selected="selected"' : set_select('salary_component_amount_type['.$key.']', 'fixed'); ?>>Fixed</option>
                                                        <option value="based_on_other" <?php echo ($component_amount_type == 'based_on_other') ? 'selected="selected"' : set_select('salary_component_amount_type['.$key.']', 'based_on_other'); ?>>Based on other heads</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <div class="show_components" style="<?php echo (isset($reference)) ? '' : 'display:none'; ?>">
                                                        <select name="reference_id[<?php echo $key; ?>]" id="reference_id_<?php echo $earn_head->id; ?>" class="form-control  reference_id">
                                                            <option value="">Select Head</option>
                                                            <?php foreach ($earning_heads as $refVal) : ?>
                                                                <option value="<?php echo $refVal->id; ?>" <?php echo (isset($reference) && $reference == $refVal->id) ? 'selected="selected"' : set_select('reference_id['.$key.']', $refVal->id); ?>><?php echo $refVal->head_name; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>

                                                </td>
                                                <td><input type="text" class="form-control salary_component_amount" id="salary_component_amount_<?php echo $earn_head->id; ?>" name="salary_component_amount[<?php echo $key; ?>]" value="<?php echo ($component_amount_type == 'fixed') ? set_value('salary_component_amount['.$key.']', $fixed_amount) : set_value('salary_component_amount['.$key.']', $percentage); ?>"></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </table>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="deduction_salary_component_amount_type[<?php echo $key; ?>]" class="salary_component_amount_type form-control">
                                                        <option value="">Select One</option>
                                                        <option value="fixed" <?php echo ($deduction_component_amount_type == 'fixed') ? 'selected="selected"' : set_select('deduction_salary_component_amount_type['.$key.']', 'fixed'); ?>>Fixed</option>
                                                        <option value="based_on_other" <?php echo ($deduction_component_amount_type == 'based_on_other') ? 'selected="selected"' : set_select('deduction_salary_component_amount_type['.$key.']', 'based_on_other'); ?>>Based on other heads</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <div class="show_components"  style="<?php echo (isset($deduction_reference)) ? '' : 'display:none'; ?>">
                                                        <select name="deduction_reference_id[<?php echo $key; ?>]" class="reference_id form-control">
                                                            <option value="">Select Head</option>
                                                            <?php foreach ($earning_heads as $refVal) : ?>
                                                                <option value="<?php echo $refVal->id; ?>" <?php echo (isset($deduction_reference) && $deduction_reference == $refVal->id) ? 'selected="selected"' : set_select('deduction_reference_id['.$key.']', $refVal->id); ?>><?php echo $refVal->head_name; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </td>
