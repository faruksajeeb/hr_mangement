            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control increment_amount" type="number" name="increment_amount" id="increment_amount" value="" required>
                    </div>
                    <div class="form-group col-md-12">
...
<script>
    $(document).ready(function() {
        ...
        $('.increment_amount').on('keyup', function() {
                ...
                $.ajax({
                    ...
                    $.each(response.salary_grade_allowances, function(key, value) {
                        ...
                        if (increment_based_on == 'basic' && value.head_short_name == 'basic') {
                            $('#' + value.head_short_name).val(Number(valueAmt) + Number(increment_amount));
                        } else {
        ...
        function totalCal() {
            ...
            $('#previous_gross_salary').val(previous_salary_allowance_head_total.toFixed(2));
