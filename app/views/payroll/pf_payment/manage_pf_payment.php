...
<body class="logged-in dashboard current-page add-division">
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 ">
                        ...
                        $msg = null;
                        ?>
                        <a href="" class="btn custom-btn btn-warning pull-right addPfPayment" data-toggle="modal" data-target="#addPfPayment" id="add_pf_payment"> <i class="fa fa-plus"></i> Add PF Payment</a>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $k => $val) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn custom-btn btn-sm btn-default edit_pf_payment" id='<?php echo $val->id; ?>' href="#"><span class="glyphicon glyphicon-edit"> </span> Edit</a>
                        ...
                        <!-- Add/Edit Modal -->
                        <div class="modal fade" id="addPfPayment" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_pf_payment').click(function(e) {
                $.ajax({
                    url: url_prefix + "add-pf-payment",
                    dataType: 'html',
                    type: 'GET',
                    data: {
                    ...
                    $("#addPfPayment").modal("show");

                });
            });
            $(document).on("click", ".edit_pf_payment", function(event) {
                edit_id = $(this).attr('id');
                if (edit_id) {
                    $.ajax({
                        url: url_prefix + "edit-pf-payment",
                        dataType: 'html',
                        type: 'GET',
                        data: {
                            edit_id: edit_id
