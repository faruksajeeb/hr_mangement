...
<body class="logged-in dashboard current-page add-division">
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 ">
                        ...
                        $msg = null;
                        ?>
                        <a href="" class="btn custom-btn btn-warning pull-right addIncentive" data-toggle="modal" data-target="#addIncentive" id="add_incentive"> <i class="fa fa-plus"></i> Add Incentive</a>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $k => $val) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn custom-btn btn-sm btn-default edit_incentive" id='<?php echo $val->id; ?>' href="#"><span class="glyphicon glyphicon-edit"> </span> Edit</a>
                        ...
                        <!-- Add/Edit Modal -->
                        <div class="modal fade" id="addIncentive" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_incentive').click(function(e) {
                $.ajax({
                    url: url_prefix + "add-incentive",
                    dataType: 'html',
                    type: 'GET',
                    data: {
                    ...
                    $("#addIncentive").modal("show");

                });
            });
            $(document).on("click", ".edit_incentive", function(event) {
                edit_id = $(this).attr('id');
                if (edit_id) {
                    $.ajax({
                        url: url_prefix + "edit-incentive",
                        dataType: 'html',
                        type: 'GET',
                        data: {
                            edit_id: edit_id
