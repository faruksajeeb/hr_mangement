...
<head>
    ...
    <title>HRMS | Advance Salary</title>
    <!--chosen-->
...
<body class="logged-in dashboard current-page add-division">
            ...
            <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 ">
                        ...
                        $msg = null;
                        ?>
                        <a href="" class="btn custom-btn btn-warning pull-right addAdvanceSalary" data-toggle="modal" data-target="#addAdvanceSalary" id="add_advance_salary"> <i class="fa fa-plus"></i> Add Advance Salary</a>
                        <table id="example" class="display compact table" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                #dd($advance_salaries);
                                foreach ($advance_salaries as $k => $val) : ?>
                                    <tr>
                                        <td><?php echo $k + 1; ?></td>
                                        <td>
                                            <div class="row">
                                        ...
                                        <td>
                                            <a class="btn custom-btn btn-sm btn-default edit_advance_salary" id='<?php echo $val->id; ?>' href="#"><span class="glyphicon glyphicon-edit"> </span> Edit</a>
                        ...
                        <!-- Add/Edit Modal -->
                        <div class="modal fade" id="addAdvanceSalary" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_advance_salary').click(function(e) {
                $.ajax({
                    url: url_prefix + "add-advance-salary",
                    dataType: 'html',
                    type: 'GET',
                    data: {
                    ...
                    $("#addAdvanceSalary").modal("show");

                });
            });
            $(document).on("click", ".edit_advance_salary", function(event) {
                edit_id = $(this).attr('id');
                if (edit_id) {
                    $.ajax({
                        url: url_prefix + "edit-advance-salary",
                        dataType: 'html',
                        type: 'GET',
                        data: {
                            edit_id: edit_id
