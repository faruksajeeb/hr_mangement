                ...
                <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 display-list">
                            <table id="example" class="table table-responsive table-sm">
                                <thead>
                                <th>#</th>
                                <th>Leave Date</th>
                                <th>Emp Name</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($employee_leaves as $employee_leave) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $employee_leave->emp_name ?></td>
                                            <td><?php echo $employee_leave->emp_id ?></td>
                                            <td><?php echo $employee_leave->company_name ?></td>
                                            <td><?php echo $employee_leave->division_name ?></td>
                                            <td><?php echo $employee_leave->designation_name ?></td>
