    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <div class="wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?php echo base_url(); ?>vahicles/addcarlog" method="post" onSubmit="return validate();" class="myForm" id="myForm"  name="myForm" enctype="multipart/form-data">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-8"> 
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 bgcolor_D8D8D8">Driver</div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9"><input type="text" name="drived_km" id="drived_km" onkeypress="return isNumber(event);" autocomplete="off" value="<?php print $cost_info['Drived_km'] ?>"/></div>
                                    </div>                                                                       
                                    <div class="row">
