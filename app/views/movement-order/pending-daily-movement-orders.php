...
<head>
    ...
    <title>HRMS | Pending Daily Movement Orders </title>
    <!--chosen-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.second_approve_status').editable({
                        ...
                        <table id="example" class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $slNo++; ?></td>
                                        <td><?php echo $employeeMovementOrder->emp_name ?></td>
                                        <td><?php echo $employeeMovementOrder->company_name ?></td>
                                        ...
                                        <td>
                                            <?php if (($this->session->userdata('user_type') == 1) || ($this->session->userdata('user_type') == 10)) { ?>
                                                <a href="#" rel="tooltip" data-placement="top" data-inputclass="select_class" class="second_approve_status" id="second_approval" data-type="select" data-title="Change Status" data-pk="<?php echo $employeeMovementOrder->id; ?>" data-url="<?php echo base_url(); ?>empattendance/updateApprovalStatus/emp_informed">
                                        ...
                                        <td>
                                            <?php if (($this->session->userdata('user_type') == 1) || ($this->session->userdata('user_type') == 10)) { ?>
                                                <a href="#" rel="tooltip" data-placement="top" data-inputclass="select_class" class="remarks" id="status_comments" data-type="text" data-title="Enter remarks" data-pk="<?php echo $employeeMovementOrder->id; ?>" data-url="<?php echo base_url(); ?>empattendance/updateApprovalStatus/emp_informed">
                                                    <?php echo $employeeMovementOrder->status_comments; ?>
                                                </a>
                                            <?php } else {
                                                echo $employeeMovementOrder->status_comments;
                                            } ?>
                                        </td>
                                        <td>
                                            <?php if ($employeeMovementOrder->first_approval == 0 && $employeeMovementOrder->second_approval == 0) { ?>
                                                <!-- <a href="<?php echo base_url("edit-employee-movement") . "/" . $employeeMovementOrder->id; ?>?<?php echo time() . "-_+="; ?>" class="btn btn-sm btn-warning">edit</a> -->
                                            ...
                                            <?php } ?>
                                            <!-- <a href="<?php echo base_url(); ?>print-daily-movement/<?php echo $employeeMovementOrder->id; ?>" target="_blank" class="">Print </a> -->
                                        </td>
