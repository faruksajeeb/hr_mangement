...
<html lang="en">
    <head>
        ...
        <title>HRMS | Delivered Items</title>
        <?php
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%" border="1">
                                ...
                                foreach ($salesItems AS $salesItem) {
                                    ?>
                                        <tr>
                                            <td><?php echo $slNo++; ?></td>
                                            <td><?php echo "#".str_pad($salesItem->delivery_id, 11, '00000000000', STR_PAD_LEFT); ?></td>
                                            
                                            <td>
                                                <a title="view" style="display:inline-block"    id="<?php echo $salesItem->sales_id; ?>" class=" sales_detail" >
                                                 <?php echo "#".str_pad($salesItem->sales_id, 11, '00000000000', STR_PAD_LEFT); ?>
                                                </a>
                                               
                                            </td>
                                            <td><?php echo $salesItem->sales_date; ?></td>                                            
                                            <td><?php echo $salesItem->delivered_date; ?></td>                                            
                                            <td><?php echo $salesItem->consumer_name; ?></td>                                            
                                            <td><?php echo $salesItem->item_name; ?></td>                                            
                                            <td style="text-align:center"><?php echo $salesItem->delivered_qty. " <small>".$salesItem->short_name."</small>"; ?></td>                                            
                                            <td><?php echo $salesItem->received_by; ?></td>
                                            <td>
                                               
                                                <a title="Delete"  <?php if($salesItem->returned_qty>0){ echo "disabled"; }?> onclick="return ConfirmDelete()"   href="<?php echo site_url("delete-delivered-product") . '/' . $salesItem->id. '/' . $salesItem->sales_detail_id. '/' . $salesItem->item_id. '/' . $salesItem->delivered_qty; ?>" style="display:inline-block" class="btn btn-sm btn-danger" >
