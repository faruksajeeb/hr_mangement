<br/>
<?php
$dataCount = count($item_wise_sales);
if ($dataCount > 0) {
...
<table cellspacing="0" width="100%" >
    ...
    <table cellspacing="0" width="100%" border="1">
        ...
        <tbody>
            ...
            foreach ($item_wise_sales as $item) {
                ?>
                <tr>
                    <td><?php echo $slNo++; ?></td>
            ...
            <?php 
            $issueTotal +=  $item->delivered_qty;
            } 
            ?>
                <tr>
                    <th colspan="6" style="text-align: right">Issue Total: </th>
                    <th><?php echo $issueTotal; ?></th>
                </tr>
        </tbody>
    </table>  
    </div>
...
?>
   <script>
    ...
    <span style="padding-left:8px;font-family:Verdana, Geneva, sans-serif">Item Wise Item Issue  Report <br><?php print $nowbigmonth; ?></span>' +
                '</div>\n\
    </div><br>';
        popupWin.document.write('<html><head><title>Item Wise Item Issue Report </title>\n\
    \n\
    \n\
    \n\
    \n\
