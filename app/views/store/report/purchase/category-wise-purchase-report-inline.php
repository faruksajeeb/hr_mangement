<br/>
<?php
$dataCount = count($category_wise_purchases);
if ($dataCount > 0) {
...
<table cellspacing="0" width="100%" >
    ...
    <table cellspacing="0" width="100%" border="1">
        ...
        <tbody>
            ...
            foreach ($category_wise_purchases as $item) {
                ?>
                <tr>
                    <td><?php echo $slNo++; ?></td>
...
?>
   <script>
    ...
    <span style="padding-left:8px;font-family:Verdana, Geneva, sans-serif">Category Wise Item Purchase Report <br><?php print $nowbigmonth; ?></span>' +
                '</div>\n\
    </div><br>';
        popupWin.document.write('<html><head><title>Category Wise Item Purchase Report </title>\n\
    \n\
    \n\
    \n\
    \n\
