...
<html lang="en">
    <head>
        ...
        <title>HRMS | Category Wise Purchase Report</title>
         <!--chosen--> 
        ...
        <script>
            $(document).ready(function () {
                 $('#employee_id').change(function(){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>StoreReportController/getCategoryWisePurchaseReport",
                            data:{ 
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row under-header-bar text-center"> 
                    <h4> Category Wise Purchase Report </h4>         
                </div>
                <br/>
                <div class="wrapper">
                    <div class="row">
