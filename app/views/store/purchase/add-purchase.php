    ...
    <head>
        ...
        <script>
            ...
            function addItem(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(".item_grid").append('<tr style="border: 1px solid #2F4F4F;">' + sl + a + c + d + e + f + h + i + l + m + '</tr>');
            ...
            function validate() {
                var valid = true;
                var msg = "<ul>";
                if (document.myForm.supplier_name.value == "") {
                    if (valid) { //only receive focus if its the first error
                        document.myForm.supplier_name.focus();
                        document.myForm.supplier_name.style.border = "solid 1px red";
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 add-form">
                            <div class="row add-form-heading">
                                <div class="col-md-12 "><span class="glyphicon glyphicon-plus-sign"> </span> Add Purchase</div>
                            </div>

                            <form  id="myForm"  name="myForm"  action="<?php echo base_url(); ?>add-purchase"  onSubmit="return validate();"  method="POST" class='form form-bordered'>
                                ...
                                <div class="form-group">
                                    <label for="textfield" class="control-label col-sm-2">Supplier name</label>
                                    <div class="col-sm-2">
                                        <select name="supplier_name"  id="supplier_name" class='form-control select2-me supplier_name' style="width:100%;">
                                            <option value="">Supplier name</option>
                                            <?php
                                            foreach ($vendors AS $vendor) {
                                                ?>
                                                <option value="<?php echo $vendor->id; ?>" <?php if($vendor_id==$vendor->id){ echo "selected"; }?>><?php echo $vendor->supplier_name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <label for="textfield" class="control-label col-sm-2">Delivered By</label>
                                    <div class="col-sm-2">
                                        <input type="text" placeholder="Deliverd by"  class="form-control " id="deliverd_by" name="deliverd_by"/> 
                                    </div> 
                                    <label for="textfield" class="control-label col-sm-2">Purchase Date</label>
                                    <div class="col-sm-2">
                                    <?php
                                    ...
                                    ?>
                                        <input type="text" placeholder="" value="<?php echo $current_date; ?>"  class="form-control datepicker" id="purchase_date" name="purchase_date"/>  
                                    </div>
                                </div>
                                <div class="row"  style="border-bottom:1px solid #FFF"></div>
                                        ...
                                        <tfoot>               
                                            ...
                                            <tr>                    
                                                ...
                                                <th class="total" style="text-align: right;">              
                                                    <input type="submit" name="save_btn" class="btn btn-primary " value="Save Record" /> 
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
