...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><?php echo lang('edit_group_heading');?></div>
                            </div>
                                ...
                                <div class="span12">
                                      ...
                                      <fieldset>
                                        ...
                                        <div class="control-group <?=(form_error('group_name'))?'error':''?>">
                                          <label class="control-label" for="first_name"><?php echo lang('edit_group_name_label', 'group_name');?></label>
                                          <div class="controls">
                                        ...
                                        <div class="control-group <?=(form_error('description'))?'error':''?>">
                                          <label class="control-label" for="focusedInput"><?php echo lang('edit_group_desc_label', 'description');?></label>
                                          <div class="controls">
