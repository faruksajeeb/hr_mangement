                        ...
                        <div class="modal fade" id="addModal"  data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="user_form" action="<?php echo base_url(); ?>user/saveUser" method="post" onSubmit="return validate();" class="form-horizontal" id="myForm"  name="myForm" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8"><input type="text" name="employee_id" id="employee_id" value="" required></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3 bgcolor_D8D8D8">Name *:</div>
                                                        <div class="col-md-8"><input type="text" name="fullname" id="fullname" value="" required></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3 bgcolor_D8D8D8">User Name *:</div>
                                                        <div class="col-md-8"><input type="text" name="user_name" id="user_name" value="" required></div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3 bgcolor_D8D8D8">E-mail address:</div>
                                                        <div class="col-md-8"><input type="email" name="email_address" id="email_address" value="" required></div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8"><input type="password" name="confirm_password" id="confirm_password" required></div>
                                                    </div>
                                                    <div class="row">
    ...
    echo 'selected="selected"';
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-default pull-right" name="add_btn" value="submit" style="width:150px;" >
                                            <span class="glyphicon glyphicon-save-file">  Save </span> <span id="tag_save_btn"></span>
                                        </button>
                                    </div>
                                     </form>
