...
class Add_attendance_controller {
    public function __construct()
    {
        $this->CI =& get_instance();
    }

    function add_attendance_action($post_data=array(), $content_id, $informed_start_date){
        //$ci=& get_instance();
        $this->CI->load->database(); 
        $msg = "";
        $emp_code=$post_data['emp_name']; 
       // $emp_attendance_date=$post_data['emp_attendance_start_date'];
        ...
        $has_attendance = $this->CI->emp_attendance_model->getemp_dailyattendance($content_id, $informed_start_date);
        if($has_attendance){
            $params = array(
                'login_time'            =>  $emp_login_time,
                'logout_time'           =>  $emp_logout_time,
                'attendance_date'       =>  $informed_start_date,
            ...
            $update_condition=array('content_id' => $content_id, 'attendance_date' => $informed_start_date);
