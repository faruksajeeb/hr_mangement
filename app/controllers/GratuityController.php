...
class GratuityController extends CI_Controller
{
    ...
    function manage()
    {
        ...
        FROM tbl_gratuity MA 
        LEFT JOIN search_field_emp SFE ON SFE.content_id=MA.content_id 
        ")->result();
        $this->load->view('payroll/gratuity/manage_gratuity', $data);
    }
    function create()
    {
        ...
        echo  $this->load->view('payroll/gratuity/add_gratuity', $data);
    }
    function save()
    {
        date_default_timezone_set('Asia/Dhaka');
        $data['title'] = "Save Gratuity";
        ...
        if ($editId = $input['edit_id']) {
            $this->db->where('id', $editId)->update('tbl_gratuity', $salaryData);
            $this->session->set_flashdata('message', "Gratuity data updated successfully!");
        } else {
            $this->db->insert('tbl_gratuity', $salaryData);
            $this->session->set_flashdata('message', "Gratuity added successfully!");
        }
    ...
    function check_duplicate($emp_content_id)
    {
        ...
        $result = $this->db->get('tbl_gratuity')->num_rows();
