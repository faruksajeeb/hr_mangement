...
class Payroll extends CI_Controller
{
    ...
    function editSalary()
    {
        ...
        $data['edit_data'] = $this->db->query("SELECT ES.*,EP.bank_id,EP.branch_name,EP.bank_account_no,EP.pay_type_id,EP.comments,EP.routing_number
        FROM emp_salary ES 
        LEFT JOIN emp_payment_method EP ON EP.content_id=ES.content_id
    ...
    function saveSalary()
    {
        ...
        $this->form_validation->set_rules('hma', 'hma', 'trim|numeric');
        ...
        $this->form_validation->set_rules('routing_number', 'routing_number', 'trim|numeric');
